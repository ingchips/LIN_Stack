...
void button_test_init(void)
{
    ...
    GIO_ConfigIntSource(USER_BUTTON_2, GIO_INT_EN_LOGIC_LOW_OR_FALLING_EDGE, GIO_INT_EDGE);
    GIO_ConfigIntSource(USER_BUTTON_3, GIO_INT_EN_LOGIC_LOW_OR_FALLING_EDGE, GIO_INT_EDGE);
