 ...
 * Definitions
 ******************************************************************************/
#define SLAVE       LINR_SLAVE
#define MASTER      LINR_MASTER
...
typedef enum {
    ...
    LIN_OP_TIMEOUT           = 0x0EU,    /*!< Lin operation timeout flag */
    LIN_SENDING_BREAK_FIELD  = 0X0FU,    /*!< Indicate that Break Field is sending by master. */
    LIN_SENDING_SYNC_FIELD   = 0X10U,    /*!< Indicate that sync Field is sending by master. */
    LIN_SENDING_PID_FIELD    = 0X11U,    /*!< Indicate that PID Field is sending by master. */
    LIN_RECV_SYNC_FIELD_OK   = 0x12U,    /*!< Indicate that correct SYNC Field was received. */
    LIN_RECV_BREAK_FIELD_START = 0x13U,  /*!< Indicate that receiving break now. */
    LIN_RECV_BREAK_FIELD_ERR   = 0x14U,  /*!< Indicate that receiving break fail. */
    LIN_GO_TO_SLEEP          = 0x15U,    /*!< Lin go to sleep. */
} lin_event_id_t;
...
typedef enum {
    ...
    LIN_NODE_STATE_SEND_SYNC              = 0x04U,    /*!< Send sync state */
    LIN_NODE_STATE_RECV_SYNC              = 0x05U,    /*!< Receive the synchronization byte state */
    ...
    LIN_NODE_STATE_RECEIVING_BREAK        = 0x0CU,    /*!< Receiving break state */
} lin_node_state_t;
...
typedef struct {
    ...
    uint8_t  currentBreakCharTransmitLength;    /*!< Current transmit break char length */
    uint8_t  currentBreakCharDetectLength;      /*!< Current detect break char length */
...
void LIN_DRV_GPIO_IRQHandler(uint32_t instance);
