...
ll_config = 0x0000cde9;
ll_free = 0x0000cdf9;
ll_get_heap_free_size = 0x0000ce05;
ll_hint_on_ce_len = 0x0000ce15;
ll_legacy_adv_set_interval = 0x0000ce4d;
ll_malloc = 0x0000ce5d;
ll_query_timing_info = 0x0000cf95;
ll_scan_set_fixed_channel = 0x0000d039;
ll_set_adv_access_address = 0x0000d231;
ll_set_adv_coded_scheme = 0x0000d23d;
ll_set_conn_coded_scheme = 0x0000d26d;
ll_set_conn_latency = 0x0000d299;
ll_set_conn_tx_power = 0x0000d2c9;
ll_set_def_antenna = 0x0000d311;
ll_set_initiating_coded_scheme = 0x0000d32d;
ll_set_max_conn_number = 0x0000d339;
nibble_for_char = 0x0001e16d;
platform_32k_rc_auto_tune = 0x0001e209;
platform_32k_rc_tune = 0x0001e285;
platform_calibrate_32k = 0x0001e299;
platform_config = 0x0001e29d;
platform_controller_run = 0x0001e3c1;
platform_enable_irq = 0x0001e3f9;
platform_get_gen_os_driver = 0x0001e431;
platform_get_task_handle = 0x0001e43d;
platform_get_us_time = 0x0001e455;
platform_get_version = 0x0001e459;
platform_hrng = 0x0001e461;
platform_init_controller = 0x0001e469;
platform_os_idle_resumed_hook = 0x0001e485;
platform_patch_rf_init_data = 0x0001e489;
platform_post_sleep_processing = 0x0001e495;
platform_pre_sleep_processing = 0x0001e49b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001e4a1;
platform_printf = 0x0001e4a5;
platform_raise_assertion = 0x0001e4b9;
platform_rand = 0x0001e4cd;
platform_read_info = 0x0001e4d1;
platform_read_persistent_reg = 0x0001e501;
platform_reset = 0x0001e511;
platform_set_evt_callback = 0x0001e535;
platform_set_evt_callback_table = 0x0001e549;
platform_set_irq_callback = 0x0001e555;
platform_set_irq_callback_table = 0x0001e571;
platform_set_rf_clk_source = 0x0001e57d;
platform_set_rf_init_data = 0x0001e589;
platform_set_rf_power_mapping = 0x0001e595;
platform_set_timer = 0x0001e5a1;
platform_shutdown = 0x0001e5a5;
platform_switch_app = 0x0001e5a9;
platform_trace_raw = 0x0001e5d5;
platform_write_persistent_reg = 0x0001e5ed;
printf_hexdump = 0x0001e5fd;
reverse_128 = 0x0001e971;
reverse_24 = 0x0001e977;
reverse_48 = 0x0001e97d;
reverse_56 = 0x0001e983;
reverse_64 = 0x0001e989;
reverse_bd_addr = 0x0001e98f;
reverse_bytes = 0x0001e995;
sm_add_event_handler = 0x0001ec55;
sm_address_resolution_lookup = 0x0001edad;
sm_authenticated = 0x0001f10d;
sm_authorization_decline = 0x0001f11b;
sm_authorization_grant = 0x0001f13b;
sm_authorization_state = 0x0001f15b;
sm_bonding_decline = 0x0001f175;
sm_config = 0x0001f595;
sm_config_conn = 0x0001f5ad;
sm_encryption_key_size = 0x0001f763;
sm_just_works_confirm = 0x0001fc9d;
sm_le_device_key = 0x0001ffd9;
sm_passkey_input = 0x0002006f;
sm_private_random_address_generation_get = 0x0002041d;
sm_private_random_address_generation_get_mode = 0x00020425;
sm_private_random_address_generation_set_mode = 0x00020431;
sm_private_random_address_generation_set_update_period = 0x00020459;
sm_register_oob_data_callback = 0x00020595;
sm_request_pairing = 0x000205a1;
sm_send_security_request = 0x00020fdb;
sm_set_accepted_stk_generation_methods = 0x00021001;
sm_set_authentication_requirements = 0x0002100d;
sm_set_encryption_key_size_range = 0x00021019;
sscanf_bd_addr = 0x00021375;
sysSetPublicDeviceAddr = 0x00021729;
uuid128_to_str = 0x00021ea1;
uuid_add_bluetooth_prefix = 0x00021ef9;
uuid_has_bluetooth_prefix = 0x00021f19;
