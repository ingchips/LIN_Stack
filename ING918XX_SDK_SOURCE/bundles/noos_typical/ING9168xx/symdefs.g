...
gap_add_whitelist = 0x02006009;
gap_aes_encrypt = 0x02006015;
gap_clear_white_lists = 0x02006059;
gap_clr_adv_set = 0x02006065;
gap_clr_periodic_adv_list = 0x02006071;
gap_create_connection_cancel = 0x0200607d;
...
gap_le_read_channel_map = 0x02006239;
gap_periodic_adv_create_sync = 0x020062a5;
gap_periodic_adv_create_sync_cancel = 0x020062c9;
gap_periodic_adv_set_info_transfer = 0x020062d5;
gap_periodic_adv_sync_transfer = 0x020062e5;
gap_periodic_adv_sync_transfer_param = 0x020062f5;
gap_periodic_adv_term_sync = 0x02006311;
gap_read_antenna_info = 0x02006399;
gap_read_periodic_adv_list_size = 0x020063a5;
gap_read_phy = 0x020063b1;
gap_read_remote_used_features = 0x020063bd;
gap_read_remote_version = 0x020063c9;
gap_read_rssi = 0x020063d5;
gap_remove_whitelist = 0x020063e1;
gap_rmv_adv_set = 0x0200645d;
gap_rmv_dev_from_periodic_list = 0x02006469;
gap_rx_test_v2 = 0x02006479;
gap_rx_test_v3 = 0x02006489;
gap_set_adv_set_random_addr = 0x020064d5;
gap_set_connection_cte_request_enable = 0x0200651d;
gap_set_connection_cte_response_enable = 0x02006539;
gap_set_connection_cte_rx_param = 0x02006549;
gap_set_connection_cte_tx_param = 0x020065a5;
gap_set_connection_parameter_range = 0x020065f9;
gap_set_connectionless_cte_tx_enable = 0x02006611;
gap_set_connectionless_cte_tx_param = 0x02006621;
gap_set_connectionless_iq_sampling_enable = 0x02006681;
gap_set_data_length = 0x020066e5;
gap_set_def_phy = 0x020066fd;
gap_set_ext_adv_data = 0x0200670d;
gap_set_ext_adv_enable = 0x02006725;
gap_set_ext_adv_para = 0x020067a1;
gap_set_ext_scan_enable = 0x02006871;
gap_set_ext_scan_para = 0x02006889;
gap_set_ext_scan_response_data = 0x02006931;
gap_set_host_channel_classification = 0x02006949;
gap_set_periodic_adv_data = 0x02006959;
gap_set_periodic_adv_enable = 0x020069c9;
gap_set_periodic_adv_para = 0x020069d9;
gap_set_periodic_adv_rx_enable = 0x020069f1;
gap_set_phy = 0x02006a01;
gap_set_random_device_address = 0x02006a1d;
gap_start_ccm = 0x02006a4d;
gap_test_end = 0x02006aa1;
...
ll_adjust_conn_peer_tx_power = 0x0200bb35;
ll_aes_encrypt = 0x0200bb61;
ll_config = 0x0200bbd5;
ll_free = 0x0200bbe5;
ll_get_heap_free_size = 0x0200bbf1;
ll_hint_on_ce_len = 0x0200bc01;
ll_legacy_adv_set_interval = 0x0200bc39;
ll_malloc = 0x0200bc49;
ll_scan_set_fixed_channel = 0x0200bdb9;
ll_set_adv_access_address = 0x0200bfb1;
ll_set_adv_coded_scheme = 0x0200bfbd;
ll_set_conn_coded_scheme = 0x0200bff5;
ll_set_conn_latency = 0x0200c021;
ll_set_conn_tx_power = 0x0200c051;
ll_set_def_antenna = 0x0200c08d;
ll_set_initiating_coded_scheme = 0x0200c0ad;
ll_set_max_conn_number = 0x0200c0b9;
ll_set_tx_power_range = 0x0200c155;
nibble_for_char = 0x0201e9a5;
platform_32k_rc_auto_tune = 0x0201ea3d;
platform_32k_rc_tune = 0x0201ea89;
platform_calibrate_32k = 0x0201eaa5;
platform_config = 0x0201eaa9;
platform_controller_run = 0x0201ebc9;
platform_enable_irq = 0x0201ec01;
platform_get_gen_os_driver = 0x0201ec35;
platform_get_task_handle = 0x0201ec41;
platform_get_us_time = 0x0201ec59;
platform_get_version = 0x0201ec5d;
platform_hrng = 0x0201ec65;
platform_init_controller = 0x0201ec6d;
platform_os_idle_resumed_hook = 0x0201ec89;
platform_patch_rf_init_data = 0x0201ec8d;
platform_post_sleep_processing = 0x0201ec99;
platform_pre_sleep_processing = 0x0201ec9f;
platform_pre_suppress_ticks_and_sleep_processing = 0x0201eca5;
platform_printf = 0x0201eca9;
platform_raise_assertion = 0x0201ecbd;
platform_rand = 0x0201ecd1;
platform_read_info = 0x0201ecd5;
platform_read_persistent_reg = 0x0201ed05;
platform_reset = 0x0201ed11;
platform_set_evt_callback = 0x0201ed25;
platform_set_evt_callback_table = 0x0201ed39;
platform_set_irq_callback = 0x0201ed45;
platform_set_irq_callback_table = 0x0201ed61;
platform_set_rf_clk_source = 0x0201ed6d;
platform_set_rf_init_data = 0x0201ed79;
platform_set_rf_power_mapping = 0x0201ed85;
platform_set_timer = 0x0201ed91;
platform_shutdown = 0x0201ed95;
platform_switch_app = 0x0201ed99;
platform_trace_raw = 0x0201edb1;
platform_write_persistent_reg = 0x0201edc9;
printf_hexdump = 0x0201eddd;
reverse_128 = 0x0201f151;
reverse_24 = 0x0201f157;
reverse_48 = 0x0201f15d;
reverse_56 = 0x0201f163;
reverse_64 = 0x0201f169;
reverse_bd_addr = 0x0201f16f;
reverse_bytes = 0x0201f175;
sm_add_event_handler = 0x0201f491;
sm_address_resolution_lookup = 0x0201f5e9;
sm_authenticated = 0x0201f949;
sm_authorization_decline = 0x0201f957;
sm_authorization_grant = 0x0201f977;
sm_authorization_state = 0x0201f997;
sm_bonding_decline = 0x0201f9b1;
sm_config = 0x0201fdc9;
sm_config_conn = 0x0201fde1;
sm_encryption_key_size = 0x0201ff97;
sm_just_works_confirm = 0x020204d1;
sm_le_device_key = 0x0202080d;
sm_passkey_input = 0x020208a3;
sm_private_random_address_generation_get = 0x02020c51;
sm_private_random_address_generation_get_mode = 0x02020c59;
sm_private_random_address_generation_set_mode = 0x02020c65;
sm_private_random_address_generation_set_update_period = 0x02020c8d;
sm_register_oob_data_callback = 0x02020dc9;
sm_request_pairing = 0x02020dd5;
sm_send_security_request = 0x02021813;
sm_set_accepted_stk_generation_methods = 0x02021839;
sm_set_authentication_requirements = 0x02021845;
sm_set_encryption_key_size_range = 0x02021851;
sscanf_bd_addr = 0x02021bb1;
sysSetPublicDeviceAddr = 0x02022015;
uuid128_to_str = 0x020227c5;
uuid_add_bluetooth_prefix = 0x0202281d;
uuid_has_bluetooth_prefix = 0x0202283d;
