...
--define_symbol ll_config=0x0000c9f5
--define_symbol ll_free=0x0000ca05
--define_symbol ll_get_heap_free_size=0x0000ca11
--define_symbol ll_hint_on_ce_len=0x0000ca21
--define_symbol ll_legacy_adv_set_interval=0x0000ca59
--define_symbol ll_malloc=0x0000ca69
--define_symbol ll_query_timing_info=0x0000cba1
--define_symbol ll_scan_set_fixed_channel=0x0000cc45
--define_symbol ll_set_adv_access_address=0x0000ce3d
--define_symbol ll_set_adv_coded_scheme=0x0000ce49
--define_symbol ll_set_conn_coded_scheme=0x0000ce79
--define_symbol ll_set_conn_latency=0x0000cea5
--define_symbol ll_set_conn_tx_power=0x0000ced5
--define_symbol ll_set_def_antenna=0x0000cf1d
--define_symbol ll_set_initiating_coded_scheme=0x0000cf39
--define_symbol ll_set_max_conn_number=0x0000cf45
--define_symbol nibble_for_char=0x0001ce99
--define_symbol platform_32k_rc_auto_tune=0x0001cf35
--define_symbol platform_32k_rc_tune=0x0001cfb1
--define_symbol platform_calibrate_32k=0x0001cfc5
--define_symbol platform_config=0x0001cfc9
--define_symbol platform_controller_run=0x0001d0ed
--define_symbol platform_enable_irq=0x0001d125
--define_symbol platform_get_gen_os_driver=0x0001d15d
...
--define_symbol platform_init_controller=0x0001d195
--define_symbol platform_os_idle_resumed_hook=0x0001d1b1
--define_symbol platform_patch_rf_init_data=0x0001d1b5
--define_symbol platform_post_sleep_processing=0x0001d1c1
--define_symbol platform_pre_sleep_processing=0x0001d1c7
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001d1cd
...
--define_symbol platform_set_evt_callback_table=0x0001d275
--define_symbol platform_set_irq_callback=0x0001d281
--define_symbol platform_set_irq_callback_table=0x0001d29d
--define_symbol platform_set_rf_clk_source=0x0001d2a9
--define_symbol platform_set_rf_init_data=0x0001d2b5
--define_symbol platform_set_rf_power_mapping=0x0001d2c1
--define_symbol platform_set_timer=0x0001d2cd
...
--define_symbol reverse_128=0x0001d665
--define_symbol reverse_24=0x0001d66b
--define_symbol reverse_48=0x0001d671
--define_symbol reverse_56=0x0001d677
--define_symbol reverse_64=0x0001d67d
--define_symbol reverse_bd_addr=0x0001d683
--define_symbol reverse_bytes=0x0001d689
--define_symbol sm_add_event_handler=0x0001d7f5
--define_symbol sm_address_resolution_lookup=0x0001d94d
--define_symbol sm_authenticated=0x0001dcad
--define_symbol sm_authorization_decline=0x0001dcbb
--define_symbol sm_authorization_grant=0x0001dcdb
--define_symbol sm_authorization_state=0x0001dcfb
--define_symbol sm_bonding_decline=0x0001dd15
--define_symbol sm_config=0x0001e135
--define_symbol sm_config_conn=0x0001e14d
--define_symbol sm_encryption_key_size=0x0001e303
--define_symbol sm_just_works_confirm=0x0001e83d
--define_symbol sm_le_device_key=0x0001eb79
--define_symbol sm_passkey_input=0x0001ec0f
--define_symbol sm_private_random_address_generation_get=0x0001efbd
--define_symbol sm_private_random_address_generation_get_mode=0x0001efc5
--define_symbol sm_private_random_address_generation_set_mode=0x0001efd1
--define_symbol sm_private_random_address_generation_set_update_period=0x0001eff9
--define_symbol sm_register_oob_data_callback=0x0001f135
--define_symbol sm_request_pairing=0x0001f141
--define_symbol sm_send_security_request=0x0001fb7b
--define_symbol sm_set_accepted_stk_generation_methods=0x0001fba1
--define_symbol sm_set_authentication_requirements=0x0001fbad
--define_symbol sm_set_encryption_key_size_range=0x0001fbb9
--define_symbol sscanf_bd_addr=0x0001ff15
--define_symbol sysSetPublicDeviceAddr=0x000202c9
--define_symbol uuid128_to_str=0x000208ad
--define_symbol uuid_add_bluetooth_prefix=0x00020905
--define_symbol uuid_has_bluetooth_prefix=0x00020925
