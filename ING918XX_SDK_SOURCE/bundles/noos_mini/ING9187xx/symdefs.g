...
ll_config = 0x0000c959;
ll_free = 0x0000c969;
ll_get_heap_free_size = 0x0000c975;
ll_hint_on_ce_len = 0x0000c985;
ll_legacy_adv_set_interval = 0x0000c9bd;
ll_malloc = 0x0000c9cd;
ll_query_timing_info = 0x0000cb05;
ll_scan_set_fixed_channel = 0x0000cba9;
ll_set_adv_access_address = 0x0000cda1;
ll_set_adv_coded_scheme = 0x0000cdad;
ll_set_conn_coded_scheme = 0x0000cdd5;
ll_set_conn_latency = 0x0000cdfd;
ll_set_conn_tx_power = 0x0000ce29;
ll_set_def_antenna = 0x0000ce6d;
ll_set_initiating_coded_scheme = 0x0000ce89;
ll_set_max_conn_number = 0x0000ce95;
nibble_for_char = 0x0001ccd5;
platform_32k_rc_auto_tune = 0x0001cd65;
platform_32k_rc_tune = 0x0001cde1;
platform_calibrate_32k = 0x0001cdf5;
platform_config = 0x0001cdf9;
platform_controller_run = 0x0001cf1d;
platform_enable_irq = 0x0001cf55;
platform_get_gen_os_driver = 0x0001cf8d;
platform_get_task_handle = 0x0001cf99;
platform_get_us_time = 0x0001cfb1;
platform_get_version = 0x0001cfb5;
platform_hrng = 0x0001cfbd;
platform_init_controller = 0x0001cfc5;
platform_os_idle_resumed_hook = 0x0001cfe1;
platform_patch_rf_init_data = 0x0001cfe5;
platform_post_sleep_processing = 0x0001cff1;
platform_pre_sleep_processing = 0x0001cff7;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001cffd;
platform_printf = 0x0001d001;
platform_raise_assertion = 0x0001d015;
platform_rand = 0x0001d029;
platform_read_info = 0x0001d02d;
platform_read_persistent_reg = 0x0001d05d;
platform_reset = 0x0001d06d;
platform_set_evt_callback = 0x0001d091;
platform_set_evt_callback_table = 0x0001d0a5;
platform_set_irq_callback = 0x0001d0b1;
platform_set_irq_callback_table = 0x0001d0cd;
...
reverse_128 = 0x0001d48d;
reverse_24 = 0x0001d493;
reverse_48 = 0x0001d499;
reverse_56 = 0x0001d49f;
reverse_64 = 0x0001d4a5;
reverse_bd_addr = 0x0001d4ab;
reverse_bytes = 0x0001d4b1;
sm_add_event_handler = 0x0001d61d;
sm_address_resolution_lookup = 0x0001d775;
...
sm_send_security_request = 0x0001f9a3;
sm_set_accepted_stk_generation_methods = 0x0001f9c9;
sm_set_authentication_requirements = 0x0001f9d5;
sm_set_encryption_key_size_range = 0x0001f9e1;
sscanf_bd_addr = 0x0001fd3d;
sysSetPublicDeviceAddr = 0x000200f1;
uuid128_to_str = 0x000206d5;
uuid_add_bluetooth_prefix = 0x0002072d;
uuid_has_bluetooth_prefix = 0x0002074d;
