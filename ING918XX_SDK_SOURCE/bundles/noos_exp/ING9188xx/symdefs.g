...
ll_config = 0x0000d1d9;
ll_dhkey_generated = 0x0000d405;
ll_free = 0x0000d435;
ll_get_conn_events_info = 0x0000d441;
ll_get_conn_info = 0x0000d51d;
ll_get_heap_free_size = 0x0000d55d;
ll_hint_on_ce_len = 0x0000d56d;
ll_install_ecc_engine = 0x0000d5a5;
ll_legacy_adv_set_interval = 0x0000d5b1;
ll_lock_frequency = 0x0000d5c1;
ll_malloc = 0x0000d619;
ll_p256_key_pair_generated = 0x0000d621;
ll_raw_packet_alloc = 0x0000d7d1;
ll_raw_packet_free = 0x0000d8a5;
ll_raw_packet_get_bare_rx_data = 0x0000d8cf;
ll_raw_packet_get_iq_samples = 0x0000d995;
...
ll_raw_packet_set_fake_cte_info = 0x0000ddb9;
ll_raw_packet_set_param = 0x0000dddb;
ll_raw_packet_set_rx_cte = 0x0000de39;
ll_raw_packet_set_tx_cte = 0x0000decf;
ll_raw_packet_set_tx_data = 0x0000df0d;
ll_scan_set_fixed_channel = 0x0000dfc9;
ll_scanner_enable_iq_sampling = 0x0000dfd5;
ll_set_adv_access_address = 0x0000e269;
ll_set_adv_coded_scheme = 0x0000e275;
...
ll_set_def_antenna = 0x0000e349;
ll_set_initiating_coded_scheme = 0x0000e365;
ll_set_max_conn_number = 0x0000e371;
ll_set_tx_power_range = 0x0000e40d;
ll_unlock_frequency = 0x0000e435;
nibble_for_char = 0x00020a31;
platform_32k_rc_auto_tune = 0x00020acd;
platform_32k_rc_tune = 0x00020b49;
platform_calibrate_32k = 0x00020b5d;
platform_config = 0x00020b61;
platform_controller_run = 0x00020c85;
platform_enable_irq = 0x00020cbd;
platform_get_gen_os_driver = 0x00020cf5;
platform_get_task_handle = 0x00020d01;
platform_get_us_time = 0x00020d19;
platform_get_version = 0x00020d1d;
platform_hrng = 0x00020d25;
platform_init_controller = 0x00020d2d;
platform_os_idle_resumed_hook = 0x00020d49;
platform_patch_rf_init_data = 0x00020d4d;
platform_post_sleep_processing = 0x00020d59;
platform_pre_sleep_processing = 0x00020d5f;
platform_pre_suppress_ticks_and_sleep_processing = 0x00020d65;
platform_printf = 0x00020d69;
platform_raise_assertion = 0x00020d7d;
platform_rand = 0x00020d91;
platform_read_info = 0x00020d95;
platform_read_persistent_reg = 0x00020dc5;
platform_reset = 0x00020dd5;
platform_set_evt_callback = 0x00020df9;
platform_set_evt_callback_table = 0x00020e0d;
platform_set_irq_callback = 0x00020e19;
platform_set_irq_callback_table = 0x00020e35;
platform_set_rf_clk_source = 0x00020e41;
platform_set_rf_init_data = 0x00020e4d;
platform_set_rf_power_mapping = 0x00020e59;
platform_set_timer = 0x00020e65;
platform_shutdown = 0x00020e69;
platform_switch_app = 0x00020e6d;
platform_trace_raw = 0x00020e99;
platform_write_persistent_reg = 0x00020eb1;
printf_hexdump = 0x00020ec1;
reverse_128 = 0x00021235;
reverse_24 = 0x0002123b;
reverse_48 = 0x00021241;
reverse_56 = 0x00021247;
reverse_64 = 0x0002124d;
reverse_bd_addr = 0x00021253;
reverse_bytes = 0x00021259;
sm_add_event_handler = 0x00021559;
sm_address_resolution_lookup = 0x000216b1;
sm_authenticated = 0x00021a11;
sm_authorization_decline = 0x00021a1f;
sm_authorization_grant = 0x00021a3f;
sm_authorization_state = 0x00021a5f;
sm_bonding_decline = 0x00021a79;
sm_config = 0x00021e99;
sm_config_conn = 0x00021eb1;
sm_encryption_key_size = 0x00022067;
sm_just_works_confirm = 0x000225a1;
sm_le_device_key = 0x000228dd;
sm_passkey_input = 0x00022973;
sm_private_random_address_generation_get = 0x00022d21;
sm_private_random_address_generation_get_mode = 0x00022d29;
sm_private_random_address_generation_set_mode = 0x00022d35;
sm_private_random_address_generation_set_update_period = 0x00022d5d;
sm_register_oob_data_callback = 0x00022e99;
sm_request_pairing = 0x00022ea5;
sm_send_security_request = 0x000238df;
sm_set_accepted_stk_generation_methods = 0x00023905;
sm_set_authentication_requirements = 0x00023911;
sm_set_encryption_key_size_range = 0x0002391d;
sscanf_bd_addr = 0x00023ced;
sysSetPublicDeviceAddr = 0x000240a1;
uuid128_to_str = 0x00024841;
uuid_add_bluetooth_prefix = 0x00024899;
uuid_has_bluetooth_prefix = 0x000248b9;
