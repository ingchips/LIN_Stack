...
ll_config = 0x0000caa5;
ll_free = 0x0000cab5;
ll_get_heap_free_size = 0x0000cac1;
ll_hint_on_ce_len = 0x0000cad1;
ll_legacy_adv_set_interval = 0x0000cb09;
ll_malloc = 0x0000cb19;
ll_query_timing_info = 0x0000cc51;
ll_scan_set_fixed_channel = 0x0000ccf5;
ll_set_adv_access_address = 0x0000ceed;
ll_set_adv_coded_scheme = 0x0000cef9;
ll_set_conn_coded_scheme = 0x0000cf21;
ll_set_conn_latency = 0x0000cf49;
ll_set_conn_tx_power = 0x0000cf75;
ll_set_def_antenna = 0x0000cfb9;
ll_set_initiating_coded_scheme = 0x0000cfd5;
ll_set_max_conn_number = 0x0000cfe1;
nibble_for_char = 0x0001ce4d;
platform_32k_rc_auto_tune = 0x0001ceed;
platform_32k_rc_tune = 0x0001cf69;
platform_calibrate_32k = 0x0001cf7d;
platform_config = 0x0001cf81;
platform_enable_irq = 0x0001d0a9;
platform_get_current_task = 0x0001d0e1;
platform_get_gen_os_driver = 0x0001d105;
platform_get_heap_status = 0x0001d10d;
platform_get_task_handle = 0x0001d125;
platform_get_us_time = 0x0001d145;
platform_get_version = 0x0001d149;
platform_hrng = 0x0001d151;
platform_install_isr_stack = 0x0001d159;
platform_install_task_stack = 0x0001d165;
platform_patch_rf_init_data = 0x0001d19d;
platform_printf = 0x0001d1a9;
platform_raise_assertion = 0x0001d1bd;
platform_rand = 0x0001d1d1;
platform_read_info = 0x0001d1d5;
platform_read_persistent_reg = 0x0001d205;
platform_reset = 0x0001d215;
platform_set_evt_callback = 0x0001d239;
platform_set_evt_callback_table = 0x0001d24d;
platform_set_irq_callback = 0x0001d259;
platform_set_irq_callback_table = 0x0001d275;
platform_set_rf_clk_source = 0x0001d281;
platform_set_rf_init_data = 0x0001d28d;
platform_set_rf_power_mapping = 0x0001d299;
platform_set_timer = 0x0001d2a5;
platform_shutdown = 0x0001d2a9;
platform_switch_app = 0x0001d2ad;
platform_trace_raw = 0x0001d2d9;
platform_write_persistent_reg = 0x0001d2f1;
printf_hexdump = 0x0001d4a5;
pvPortMalloc = 0x0001df8d;
pvTaskIncrementMutexHeldCount = 0x0001e075;
pvTimerGetTimerID = 0x0001e08d;
pxPortInitialiseStack = 0x0001e0b9;
reverse_128 = 0x0001e261;
reverse_24 = 0x0001e267;
reverse_48 = 0x0001e26d;
reverse_56 = 0x0001e273;
reverse_64 = 0x0001e279;
reverse_bd_addr = 0x0001e27f;
reverse_bytes = 0x0001e285;
sm_add_event_handler = 0x0001e3f1;
sm_address_resolution_lookup = 0x0001e549;
sm_authenticated = 0x0001e8a9;
sm_authorization_decline = 0x0001e8b7;
sm_authorization_grant = 0x0001e8d7;
sm_authorization_state = 0x0001e8f7;
sm_bonding_decline = 0x0001e911;
sm_config = 0x0001ed31;
sm_config_conn = 0x0001ed49;
sm_encryption_key_size = 0x0001eeff;
sm_just_works_confirm = 0x0001f439;
sm_le_device_key = 0x0001f775;
sm_passkey_input = 0x0001f80b;
sm_private_random_address_generation_get = 0x0001fbb9;
sm_private_random_address_generation_get_mode = 0x0001fbc1;
sm_private_random_address_generation_set_mode = 0x0001fbcd;
sm_private_random_address_generation_set_update_period = 0x0001fbf5;
sm_register_oob_data_callback = 0x0001fd31;
sm_request_pairing = 0x0001fd3d;
sm_send_security_request = 0x00020777;
sm_set_accepted_stk_generation_methods = 0x0002079d;
sm_set_authentication_requirements = 0x000207a9;
sm_set_encryption_key_size_range = 0x000207b5;
sscanf_bd_addr = 0x00020b11;
sysSetPublicDeviceAddr = 0x00020ec5;
uuid128_to_str = 0x000214a5;
uuid_add_bluetooth_prefix = 0x000214fd;
uuid_has_bluetooth_prefix = 0x0002151d;
uxListRemove = 0x00021539;
uxQueueMessagesWaiting = 0x00021561;
uxQueueMessagesWaitingFromISR = 0x00021589;
uxQueueSpacesAvailable = 0x000215a5;
uxTaskGetStackHighWaterMark = 0x000215d1;
uxTaskPriorityGet = 0x000215f1;
uxTaskPriorityGetFromISR = 0x0002160d;
vListInitialise = 0x000216c7;
vListInitialiseItem = 0x000216dd;
vListInsert = 0x000216e3;
vListInsertEnd = 0x00021713;
vPortEndScheduler = 0x0002172d;
vPortEnterCritical = 0x00021759;
vPortExitCritical = 0x0002179d;
vPortFree = 0x000217d1;
vPortSuppressTicksAndSleep = 0x00021865;
vPortValidateInterruptPriority = 0x0002198d;
vQueueDelete = 0x000219e9;
vQueueWaitForMessageRestricted = 0x00021a15;
vTaskDelay = 0x00021a5d;
vTaskInternalSetTimeOutState = 0x00021aa9;
vTaskMissedYield = 0x00021ab9;
vTaskPlaceOnEventList = 0x00021ac5;
vTaskPlaceOnEventListRestricted = 0x00021afd;
vTaskPriorityDisinheritAfterTimeout = 0x00021b3d;
vTaskPrioritySet = 0x00021be9;
vTaskResume = 0x00021cb1;
vTaskStartScheduler = 0x00021d35;
vTaskStepTick = 0x00021dc5;
vTaskSuspend = 0x00021df5;
vTaskSuspendAll = 0x00021eb1;
vTaskSwitchContext = 0x00021ec1;
xPortStartScheduler = 0x00021f65;
xQueueAddToSet = 0x0002202d;
xQueueCreateCountingSemaphore = 0x00022051;
xQueueCreateCountingSemaphoreStatic = 0x0002208d;
xQueueCreateMutex = 0x000220d1;
xQueueCreateMutexStatic = 0x000220e7;
xQueueCreateSet = 0x00022101;
xQueueGenericCreate = 0x00022109;
xQueueGenericCreateStatic = 0x00022155;
xQueueGenericReset = 0x000221bd;
xQueueGenericSend = 0x00022249;
xQueueGenericSendFromISR = 0x000223b5;
xQueueGiveFromISR = 0x00022475;
xQueueGiveMutexRecursive = 0x00022519;
xQueueIsQueueEmptyFromISR = 0x00022559;
xQueueIsQueueFullFromISR = 0x0002257d;
xQueuePeek = 0x000225a5;
xQueuePeekFromISR = 0x000226cd;
xQueueReceive = 0x00022739;
xQueueReceiveFromISR = 0x00022865;
xQueueRemoveFromSet = 0x000228f9;
xQueueSelectFromSet = 0x0002291b;
xQueueSelectFromSetFromISR = 0x0002292d;
xQueueSemaphoreTake = 0x00022941;
xQueueTakeMutexRecursive = 0x00022aad;
xTaskCheckForTimeOut = 0x00022af1;
xTaskCreate = 0x00022b61;
xTaskCreateStatic = 0x00022bbd;
xTaskGetCurrentTaskHandle = 0x00022c2d;
xTaskGetSchedulerState = 0x00022c39;
xTaskGetTickCount = 0x00022c55;
xTaskGetTickCountFromISR = 0x00022c61;
xTaskIncrementTick = 0x00022c71;
xTaskPriorityDisinherit = 0x00022d3d;
xTaskPriorityInherit = 0x00022dd1;
xTaskRemoveFromEventList = 0x00022e65;
xTaskResumeAll = 0x00022ee5;
xTaskResumeFromISR = 0x00022fad;
xTimerCreate = 0x00023039;
xTimerCreateStatic = 0x0002306d;
xTimerCreateTimerTask = 0x000230a5;
xTimerGenericCommand = 0x00023111;
xTimerGetExpiryTime = 0x00023181;
xTimerGetTimerDaemonTaskHandle = 0x000231a1;
