...
ll_config = 0x0000d1c5;
ll_free = 0x0000d1d5;
ll_get_heap_free_size = 0x0000d1e1;
ll_hint_on_ce_len = 0x0000d1f1;
ll_legacy_adv_set_interval = 0x0000d229;
ll_lock_frequency = 0x0000d239;
ll_malloc = 0x0000d291;
ll_query_timing_info = 0x0000d3c9;
ll_raw_packet_alloc = 0x0000d415;
ll_raw_packet_free = 0x0000d4e9;
ll_raw_packet_get_bare_rx_data = 0x0000d513;
ll_raw_packet_get_iq_samples = 0x0000d5d9;
ll_raw_packet_get_rx_data = 0x0000d673;
ll_raw_packet_recv = 0x0000d715;
ll_raw_packet_send = 0x0000d7d1;
ll_raw_packet_set_bare_data = 0x0000d8b9;
ll_raw_packet_set_bare_mode = 0x0000d8f7;
ll_raw_packet_set_fake_cte_info = 0x0000d9fd;
ll_raw_packet_set_param = 0x0000da1f;
ll_raw_packet_set_rx_cte = 0x0000da7d;
ll_raw_packet_set_tx_cte = 0x0000db13;
ll_raw_packet_set_tx_data = 0x0000db51;
ll_scan_set_fixed_channel = 0x0000dc0d;
ll_scanner_enable_iq_sampling = 0x0000dc19;
ll_set_adv_access_address = 0x0000dead;
ll_set_adv_coded_scheme = 0x0000deb9;
ll_set_conn_coded_scheme = 0x0000dee9;
ll_set_conn_interval_unit = 0x0000df15;
ll_set_conn_latency = 0x0000df21;
ll_set_conn_tx_power = 0x0000df51;
ll_set_def_antenna = 0x0000df99;
ll_set_initiating_coded_scheme = 0x0000dfb5;
ll_set_max_conn_number = 0x0000dfc1;
ll_unlock_frequency = 0x0000e05d;
nibble_for_char = 0x0001f05d;
platform_32k_rc_auto_tune = 0x0001f0f9;
platform_32k_rc_tune = 0x0001f175;
platform_calibrate_32k = 0x0001f189;
platform_config = 0x0001f18d;
platform_controller_run = 0x0001f2b1;
platform_enable_irq = 0x0001f2e9;
platform_get_gen_os_driver = 0x0001f321;
platform_get_task_handle = 0x0001f32d;
platform_get_us_time = 0x0001f345;
platform_get_version = 0x0001f349;
platform_hrng = 0x0001f351;
platform_init_controller = 0x0001f359;
platform_os_idle_resumed_hook = 0x0001f375;
platform_patch_rf_init_data = 0x0001f379;
platform_post_sleep_processing = 0x0001f385;
platform_pre_sleep_processing = 0x0001f38b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001f391;
platform_printf = 0x0001f395;
platform_raise_assertion = 0x0001f3a9;
platform_rand = 0x0001f3bd;
platform_read_info = 0x0001f3c1;
platform_read_persistent_reg = 0x0001f3f1;
platform_reset = 0x0001f401;
platform_set_evt_callback = 0x0001f425;
platform_set_evt_callback_table = 0x0001f439;
platform_set_irq_callback = 0x0001f445;
platform_set_irq_callback_table = 0x0001f461;
platform_set_rf_clk_source = 0x0001f46d;
platform_set_rf_init_data = 0x0001f479;
platform_set_rf_power_mapping = 0x0001f485;
platform_set_timer = 0x0001f491;
platform_shutdown = 0x0001f495;
platform_switch_app = 0x0001f499;
platform_trace_raw = 0x0001f4c5;
platform_write_persistent_reg = 0x0001f4dd;
printf_hexdump = 0x0001f4ed;
reverse_128 = 0x0001f861;
reverse_24 = 0x0001f867;
reverse_48 = 0x0001f86d;
reverse_56 = 0x0001f873;
reverse_64 = 0x0001f879;
reverse_bd_addr = 0x0001f87f;
reverse_bytes = 0x0001f885;
sm_add_event_handler = 0x0001fb65;
sm_address_resolution_lookup = 0x0001fcbd;
sm_authenticated = 0x0002001d;
sm_authorization_decline = 0x0002002b;
sm_authorization_grant = 0x0002004b;
sm_authorization_state = 0x0002006b;
sm_bonding_decline = 0x00020085;
sm_config = 0x000204a5;
sm_config_conn = 0x000204bd;
sm_encryption_key_size = 0x00020673;
sm_just_works_confirm = 0x00020bad;
sm_le_device_key = 0x00020ee9;
sm_passkey_input = 0x00020f7f;
sm_private_random_address_generation_get = 0x0002132d;
sm_private_random_address_generation_get_mode = 0x00021335;
sm_private_random_address_generation_set_mode = 0x00021341;
sm_private_random_address_generation_set_update_period = 0x00021369;
sm_register_oob_data_callback = 0x000214a5;
sm_request_pairing = 0x000214b1;
sm_send_security_request = 0x00021eeb;
sm_set_accepted_stk_generation_methods = 0x00021f11;
sm_set_authentication_requirements = 0x00021f1d;
sm_set_encryption_key_size_range = 0x00021f29;
sscanf_bd_addr = 0x000222f9;
sysSetPublicDeviceAddr = 0x000226ad;
uuid128_to_str = 0x00022e25;
uuid_add_bluetooth_prefix = 0x00022e7d;
uuid_has_bluetooth_prefix = 0x00022e9d;
