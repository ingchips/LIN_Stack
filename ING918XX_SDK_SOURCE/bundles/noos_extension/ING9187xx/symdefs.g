...
ll_config = 0x0000cc39;
ll_free = 0x0000cc49;
ll_get_heap_free_size = 0x0000cc55;
ll_hint_on_ce_len = 0x0000cc65;
ll_legacy_adv_set_interval = 0x0000cc9d;
ll_lock_frequency = 0x0000ccad;
ll_malloc = 0x0000cd05;
ll_query_timing_info = 0x0000ce3d;
ll_raw_packet_alloc = 0x0000ce89;
ll_raw_packet_free = 0x0000cf5d;
ll_raw_packet_get_bare_rx_data = 0x0000cf87;
ll_raw_packet_get_rx_data = 0x0000d04d;
...
ll_scan_set_fixed_channel = 0x0000d4f1;
ll_set_adv_access_address = 0x0000d6e9;
ll_set_adv_coded_scheme = 0x0000d6f5;
ll_set_conn_coded_scheme = 0x0000d725;
ll_set_conn_interval_unit = 0x0000d751;
ll_set_conn_latency = 0x0000d75d;
ll_set_conn_tx_power = 0x0000d78d;
ll_set_def_antenna = 0x0000d7d5;
ll_set_initiating_coded_scheme = 0x0000d7f1;
ll_set_max_conn_number = 0x0000d7fd;
ll_unlock_frequency = 0x0000d899;
nibble_for_char = 0x0001d8b9;
platform_32k_rc_auto_tune = 0x0001d955;
platform_32k_rc_tune = 0x0001d9d1;
platform_calibrate_32k = 0x0001d9e5;
platform_config = 0x0001d9e9;
platform_controller_run = 0x0001db0d;
platform_enable_irq = 0x0001db45;
platform_get_gen_os_driver = 0x0001db7d;
platform_get_task_handle = 0x0001db89;
platform_get_us_time = 0x0001dba1;
platform_get_version = 0x0001dba5;
platform_hrng = 0x0001dbad;
platform_init_controller = 0x0001dbb5;
platform_os_idle_resumed_hook = 0x0001dbd1;
platform_patch_rf_init_data = 0x0001dbd5;
platform_post_sleep_processing = 0x0001dbe1;
platform_pre_sleep_processing = 0x0001dbe7;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001dbed;
platform_printf = 0x0001dbf1;
platform_raise_assertion = 0x0001dc05;
platform_rand = 0x0001dc19;
platform_read_info = 0x0001dc1d;
platform_read_persistent_reg = 0x0001dc4d;
platform_reset = 0x0001dc5d;
platform_set_evt_callback = 0x0001dc81;
platform_set_evt_callback_table = 0x0001dc95;
platform_set_irq_callback = 0x0001dca1;
platform_set_irq_callback_table = 0x0001dcbd;
platform_set_rf_clk_source = 0x0001dcc9;
platform_set_rf_init_data = 0x0001dcd5;
platform_set_rf_power_mapping = 0x0001dce1;
platform_set_timer = 0x0001dced;
platform_shutdown = 0x0001dcf1;
platform_switch_app = 0x0001dcf5;
platform_trace_raw = 0x0001dd21;
platform_write_persistent_reg = 0x0001dd39;
printf_hexdump = 0x0001dd49;
reverse_128 = 0x0001e085;
reverse_24 = 0x0001e08b;
reverse_48 = 0x0001e091;
reverse_56 = 0x0001e097;
reverse_64 = 0x0001e09d;
reverse_bd_addr = 0x0001e0a3;
reverse_bytes = 0x0001e0a9;
sm_add_event_handler = 0x0001e235;
sm_address_resolution_lookup = 0x0001e38d;
sm_authenticated = 0x0001e6ed;
sm_authorization_decline = 0x0001e6fb;
sm_authorization_grant = 0x0001e71b;
sm_authorization_state = 0x0001e73b;
sm_bonding_decline = 0x0001e755;
sm_config = 0x0001eb75;
sm_config_conn = 0x0001eb8d;
sm_encryption_key_size = 0x0001ed43;
sm_just_works_confirm = 0x0001f27d;
sm_le_device_key = 0x0001f5b9;
sm_passkey_input = 0x0001f64f;
sm_private_random_address_generation_get = 0x0001f9fd;
sm_private_random_address_generation_get_mode = 0x0001fa05;
sm_private_random_address_generation_set_mode = 0x0001fa11;
sm_private_random_address_generation_set_update_period = 0x0001fa39;
sm_register_oob_data_callback = 0x0001fb75;
sm_request_pairing = 0x0001fb81;
sm_send_security_request = 0x000205bb;
sm_set_accepted_stk_generation_methods = 0x000205e1;
sm_set_authentication_requirements = 0x000205ed;
sm_set_encryption_key_size_range = 0x000205f9;
sscanf_bd_addr = 0x000209c9;
sysSetPublicDeviceAddr = 0x00020d7d;
