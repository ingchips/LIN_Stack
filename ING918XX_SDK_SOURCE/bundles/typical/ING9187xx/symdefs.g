...
ll_set_adv_access_address = 0x0000cf89;
ll_set_adv_coded_scheme = 0x0000cf95;
ll_set_conn_coded_scheme = 0x0000cfc5;
ll_set_conn_latency = 0x0000cff1;
ll_set_conn_tx_power = 0x0000d021;
ll_set_def_antenna = 0x0000d069;
ll_set_initiating_coded_scheme = 0x0000d085;
ll_set_max_conn_number = 0x0000d091;
nibble_for_char = 0x0001d011;
platform_32k_rc_auto_tune = 0x0001d0bd;
platform_32k_rc_tune = 0x0001d139;
platform_calibrate_32k = 0x0001d14d;
platform_config = 0x0001d151;
platform_enable_irq = 0x0001d279;
platform_get_current_task = 0x0001d2b1;
platform_get_gen_os_driver = 0x0001d2d5;
platform_get_heap_status = 0x0001d2dd;
platform_get_task_handle = 0x0001d2f5;
platform_get_us_time = 0x0001d315;
platform_get_version = 0x0001d319;
platform_hrng = 0x0001d321;
platform_install_isr_stack = 0x0001d329;
platform_install_task_stack = 0x0001d335;
platform_patch_rf_init_data = 0x0001d36d;
platform_printf = 0x0001d379;
platform_raise_assertion = 0x0001d38d;
platform_rand = 0x0001d3a1;
platform_read_info = 0x0001d3a5;
platform_read_persistent_reg = 0x0001d3d5;
platform_reset = 0x0001d3e5;
platform_set_evt_callback = 0x0001d409;
platform_set_evt_callback_table = 0x0001d41d;
platform_set_irq_callback = 0x0001d429;
platform_set_irq_callback_table = 0x0001d445;
platform_set_rf_clk_source = 0x0001d451;
platform_set_rf_init_data = 0x0001d45d;
platform_set_rf_power_mapping = 0x0001d469;
platform_set_timer = 0x0001d475;
platform_shutdown = 0x0001d479;
platform_switch_app = 0x0001d47d;
platform_trace_raw = 0x0001d4a9;
platform_write_persistent_reg = 0x0001d4c1;
printf_hexdump = 0x0001d675;
pvPortMalloc = 0x0001e165;
pvTaskIncrementMutexHeldCount = 0x0001e24d;
pvTimerGetTimerID = 0x0001e265;
pxPortInitialiseStack = 0x0001e291;
reverse_128 = 0x0001e439;
reverse_24 = 0x0001e43f;
reverse_48 = 0x0001e445;
reverse_56 = 0x0001e44b;
reverse_64 = 0x0001e451;
reverse_bd_addr = 0x0001e457;
reverse_bytes = 0x0001e45d;
sm_add_event_handler = 0x0001e5c9;
sm_address_resolution_lookup = 0x0001e721;
sm_authenticated = 0x0001ea81;
sm_authorization_decline = 0x0001ea8f;
sm_authorization_grant = 0x0001eaaf;
sm_authorization_state = 0x0001eacf;
sm_bonding_decline = 0x0001eae9;
sm_config = 0x0001ef09;
sm_config_conn = 0x0001ef21;
sm_encryption_key_size = 0x0001f0d7;
sm_just_works_confirm = 0x0001f611;
sm_le_device_key = 0x0001f94d;
sm_passkey_input = 0x0001f9e3;
sm_private_random_address_generation_get = 0x0001fd91;
sm_private_random_address_generation_get_mode = 0x0001fd99;
sm_private_random_address_generation_set_mode = 0x0001fda5;
sm_private_random_address_generation_set_update_period = 0x0001fdcd;
sm_register_oob_data_callback = 0x0001ff09;
sm_request_pairing = 0x0001ff15;
sm_send_security_request = 0x0002094f;
sm_set_accepted_stk_generation_methods = 0x00020975;
sm_set_authentication_requirements = 0x00020981;
sm_set_encryption_key_size_range = 0x0002098d;
sscanf_bd_addr = 0x00020ce9;
sysSetPublicDeviceAddr = 0x0002109d;
uuid128_to_str = 0x0002167d;
uuid_add_bluetooth_prefix = 0x000216d5;
uuid_has_bluetooth_prefix = 0x000216f5;
uxListRemove = 0x00021711;
uxQueueMessagesWaiting = 0x00021739;
uxQueueMessagesWaitingFromISR = 0x00021761;
uxQueueSpacesAvailable = 0x0002177d;
uxTaskGetStackHighWaterMark = 0x000217a9;
uxTaskPriorityGet = 0x000217c9;
uxTaskPriorityGetFromISR = 0x000217e5;
vListInitialise = 0x0002189f;
vListInitialiseItem = 0x000218b5;
vListInsert = 0x000218bb;
vListInsertEnd = 0x000218eb;
vPortEndScheduler = 0x00021905;
vPortEnterCritical = 0x00021931;
vPortExitCritical = 0x00021975;
vPortFree = 0x000219a9;
vPortSuppressTicksAndSleep = 0x00021a3d;
vPortValidateInterruptPriority = 0x00021b65;
vQueueDelete = 0x00021bc1;
vQueueWaitForMessageRestricted = 0x00021bed;
vTaskDelay = 0x00021c35;
vTaskInternalSetTimeOutState = 0x00021c81;
vTaskMissedYield = 0x00021c91;
vTaskPlaceOnEventList = 0x00021c9d;
vTaskPlaceOnEventListRestricted = 0x00021cd5;
vTaskPriorityDisinheritAfterTimeout = 0x00021d15;
vTaskPrioritySet = 0x00021dc1;
vTaskResume = 0x00021e89;
vTaskStartScheduler = 0x00021f0d;
vTaskStepTick = 0x00021f9d;
vTaskSuspend = 0x00021fcd;
vTaskSuspendAll = 0x00022089;
vTaskSwitchContext = 0x00022099;
xPortStartScheduler = 0x00022141;
xQueueAddToSet = 0x00022209;
xQueueCreateCountingSemaphore = 0x0002222d;
xQueueCreateCountingSemaphoreStatic = 0x00022269;
xQueueCreateMutex = 0x000222ad;
xQueueCreateMutexStatic = 0x000222c3;
xQueueCreateSet = 0x000222dd;
xQueueGenericCreate = 0x000222e5;
xQueueGenericCreateStatic = 0x00022331;
xQueueGenericReset = 0x00022399;
xQueueGenericSend = 0x00022425;
xQueueGenericSendFromISR = 0x00022591;
xQueueGiveFromISR = 0x00022651;
xQueueGiveMutexRecursive = 0x000226f5;
xQueueIsQueueEmptyFromISR = 0x00022735;
xQueueIsQueueFullFromISR = 0x00022759;
xQueuePeek = 0x00022781;
xQueuePeekFromISR = 0x000228a9;
xQueueReceive = 0x00022915;
xQueueReceiveFromISR = 0x00022a41;
xQueueRemoveFromSet = 0x00022ad5;
xQueueSelectFromSet = 0x00022af7;
xQueueSelectFromSetFromISR = 0x00022b09;
xQueueSemaphoreTake = 0x00022b1d;
xQueueTakeMutexRecursive = 0x00022c89;
xTaskCheckForTimeOut = 0x00022ccd;
xTaskCreate = 0x00022d3d;
xTaskCreateStatic = 0x00022d99;
xTaskGetCurrentTaskHandle = 0x00022e09;
xTaskGetSchedulerState = 0x00022e15;
xTaskGetTickCount = 0x00022e31;
xTaskGetTickCountFromISR = 0x00022e3d;
xTaskIncrementTick = 0x00022e4d;
xTaskPriorityDisinherit = 0x00022f19;
xTaskPriorityInherit = 0x00022fad;
xTaskRemoveFromEventList = 0x00023041;
xTaskResumeAll = 0x000230c1;
xTaskResumeFromISR = 0x00023189;
xTimerCreate = 0x00023215;
xTimerCreateStatic = 0x00023249;
xTimerCreateTimerTask = 0x00023281;
xTimerGenericCommand = 0x000232ed;
xTimerGetExpiryTime = 0x0002335d;
xTimerGetTimerDaemonTaskHandle = 0x0002337d;
