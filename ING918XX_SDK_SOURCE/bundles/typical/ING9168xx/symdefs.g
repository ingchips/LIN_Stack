...
nibble_for_char = 0x0201eb45;
platform_32k_rc_auto_tune = 0x0201ebf1;
platform_32k_rc_tune = 0x0201ec3d;
platform_calibrate_32k = 0x0201ec59;
platform_config = 0x0201ec5d;
platform_enable_irq = 0x0201ed81;
platform_get_current_task = 0x0201edb5;
platform_get_gen_os_driver = 0x0201edd9;
platform_get_heap_status = 0x0201ede1;
platform_get_task_handle = 0x0201edf9;
platform_get_us_time = 0x0201ee19;
platform_get_version = 0x0201ee1d;
platform_hrng = 0x0201ee25;
platform_install_isr_stack = 0x0201ee2d;
platform_install_task_stack = 0x0201ee39;
platform_patch_rf_init_data = 0x0201ee71;
platform_printf = 0x0201ee7d;
platform_raise_assertion = 0x0201ee91;
platform_rand = 0x0201eea5;
platform_read_info = 0x0201eea9;
platform_read_persistent_reg = 0x0201eed9;
platform_reset = 0x0201eee5;
platform_set_evt_callback = 0x0201eef9;
platform_set_evt_callback_table = 0x0201ef0d;
platform_set_irq_callback = 0x0201ef19;
platform_set_irq_callback_table = 0x0201ef35;
platform_set_rf_clk_source = 0x0201ef41;
platform_set_rf_init_data = 0x0201ef4d;
platform_set_rf_power_mapping = 0x0201ef59;
platform_set_timer = 0x0201ef65;
platform_shutdown = 0x0201ef69;
platform_switch_app = 0x0201ef6d;
platform_trace_raw = 0x0201ef85;
platform_write_persistent_reg = 0x0201ef9d;
printf_hexdump = 0x0201f155;
pvPortMalloc = 0x0201fc29;
pvTaskIncrementMutexHeldCount = 0x0201fd11;
pvTimerGetTimerID = 0x0201fd29;
pxPortInitialiseStack = 0x0201fd55;
reverse_128 = 0x0201ff3d;
reverse_24 = 0x0201ff43;
reverse_48 = 0x0201ff49;
reverse_56 = 0x0201ff4f;
reverse_64 = 0x0201ff55;
reverse_bd_addr = 0x0201ff5b;
reverse_bytes = 0x0201ff61;
sm_add_event_handler = 0x0202027d;
sm_address_resolution_lookup = 0x020203d5;
sm_authenticated = 0x02020735;
sm_authorization_decline = 0x02020743;
sm_authorization_grant = 0x02020763;
sm_authorization_state = 0x02020783;
sm_bonding_decline = 0x0202079d;
sm_config = 0x02020bb5;
sm_config_conn = 0x02020bcd;
sm_encryption_key_size = 0x02020d83;
sm_just_works_confirm = 0x020212bd;
sm_le_device_key = 0x020215f9;
sm_passkey_input = 0x0202168f;
sm_private_random_address_generation_get = 0x02021a3d;
sm_private_random_address_generation_get_mode = 0x02021a45;
sm_private_random_address_generation_set_mode = 0x02021a51;
sm_private_random_address_generation_set_update_period = 0x02021a79;
sm_register_oob_data_callback = 0x02021bb5;
sm_request_pairing = 0x02021bc1;
sm_send_security_request = 0x020225ff;
sm_set_accepted_stk_generation_methods = 0x02022625;
sm_set_authentication_requirements = 0x02022631;
sm_set_encryption_key_size_range = 0x0202263d;
sscanf_bd_addr = 0x0202299d;
sysSetPublicDeviceAddr = 0x02022e01;
uuid128_to_str = 0x020235ad;
uuid_add_bluetooth_prefix = 0x02023605;
uuid_has_bluetooth_prefix = 0x02023625;
uxListRemove = 0x02023641;
uxQueueMessagesWaiting = 0x02023669;
uxQueueMessagesWaitingFromISR = 0x02023691;
uxQueueSpacesAvailable = 0x020236ad;
uxTaskGetStackHighWaterMark = 0x020236d9;
uxTaskPriorityGet = 0x020236f9;
uxTaskPriorityGetFromISR = 0x02023715;
vListInitialise = 0x020237d3;
vListInitialiseItem = 0x020237e9;
vListInsert = 0x020237ef;
vListInsertEnd = 0x0202381f;
vPortEndScheduler = 0x02023839;
vPortEnterCritical = 0x02023865;
vPortExitCritical = 0x020238a9;
vPortFree = 0x020238dd;
vPortSuppressTicksAndSleep = 0x02023981;
vPortValidateInterruptPriority = 0x02023aa9;
vQueueDelete = 0x02023b05;
vQueueWaitForMessageRestricted = 0x02023b31;
vTaskDelay = 0x02023b75;
vTaskInternalSetTimeOutState = 0x02023bc1;
vTaskMissedYield = 0x02023bd1;
vTaskPlaceOnEventList = 0x02023bdd;
vTaskPlaceOnEventListRestricted = 0x02023c15;
vTaskPriorityDisinheritAfterTimeout = 0x02023c55;
vTaskPrioritySet = 0x02023d01;
vTaskResume = 0x02023dc9;
vTaskStartScheduler = 0x02023e4d;
vTaskStepTick = 0x02023edd;
vTaskSuspend = 0x02023f0d;
vTaskSuspendAll = 0x02023fc9;
vTaskSwitchContext = 0x02023fd9;
xPortStartScheduler = 0x02024081;
xQueueAddToSet = 0x02024185;
xQueueCreateCountingSemaphore = 0x020241a9;
xQueueCreateCountingSemaphoreStatic = 0x020241e5;
xQueueCreateMutex = 0x02024229;
xQueueCreateMutexStatic = 0x0202423f;
xQueueCreateSet = 0x02024259;
xQueueGenericCreate = 0x02024261;
xQueueGenericCreateStatic = 0x020242ad;
xQueueGenericReset = 0x02024315;
xQueueGenericSend = 0x020243a1;
xQueueGenericSendFromISR = 0x0202450d;
xQueueGiveFromISR = 0x020245cd;
xQueueGiveMutexRecursive = 0x02024671;
xQueueIsQueueEmptyFromISR = 0x020246b1;
xQueueIsQueueFullFromISR = 0x020246d5;
xQueuePeek = 0x020246fd;
xQueuePeekFromISR = 0x02024825;
xQueueReceive = 0x02024891;
xQueueReceiveFromISR = 0x020249bd;
xQueueRemoveFromSet = 0x02024a51;
xQueueSelectFromSet = 0x02024a73;
xQueueSelectFromSetFromISR = 0x02024a85;
xQueueSemaphoreTake = 0x02024a99;
xQueueTakeMutexRecursive = 0x02024c05;
xTaskCheckForTimeOut = 0x02024c49;
xTaskCreate = 0x02024cb9;
xTaskCreateStatic = 0x02024d15;
xTaskGetCurrentTaskHandle = 0x02024d85;
xTaskGetSchedulerState = 0x02024d91;
xTaskGetTickCount = 0x02024dad;
xTaskGetTickCountFromISR = 0x02024db9;
xTaskIncrementTick = 0x02024dc9;
xTaskPriorityDisinherit = 0x02024e95;
xTaskPriorityInherit = 0x02024f29;
xTaskRemoveFromEventList = 0x02024fbd;
xTaskResumeAll = 0x0202503d;
xTaskResumeFromISR = 0x02025105;
xTimerCreate = 0x02025191;
xTimerCreateStatic = 0x020251c5;
xTimerCreateTimerTask = 0x020251fd;
xTimerGenericCommand = 0x02025269;
xTimerGetExpiryTime = 0x020252d9;
xTimerGetTimerDaemonTaskHandle = 0x020252f9;
