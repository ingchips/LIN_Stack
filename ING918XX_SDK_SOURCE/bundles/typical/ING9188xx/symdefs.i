...
--define_symbol ll_config=0x0000cf35
...
--define_symbol ll_set_adv_access_address=0x0000d37d
...
--define_symbol nibble_for_char=0x0001e2e5
--define_symbol platform_32k_rc_auto_tune=0x0001e391
--define_symbol platform_32k_rc_tune=0x0001e40d
--define_symbol platform_calibrate_32k=0x0001e421
--define_symbol platform_config=0x0001e425
--define_symbol platform_enable_irq=0x0001e54d
--define_symbol platform_get_current_task=0x0001e585
--define_symbol platform_get_gen_os_driver=0x0001e5a9
--define_symbol platform_get_heap_status=0x0001e5b1
--define_symbol platform_get_task_handle=0x0001e5c9
--define_symbol platform_get_us_time=0x0001e5e9
--define_symbol platform_get_version=0x0001e5ed
--define_symbol platform_hrng=0x0001e5f5
--define_symbol platform_install_isr_stack=0x0001e5fd
--define_symbol platform_install_task_stack=0x0001e609
--define_symbol platform_patch_rf_init_data=0x0001e641
...
--define_symbol platform_read_persistent_reg=0x0001e6a9
--define_symbol platform_reset=0x0001e6b9
--define_symbol platform_set_evt_callback=0x0001e6dd
--define_symbol platform_set_evt_callback_table=0x0001e6f1
--define_symbol platform_set_irq_callback=0x0001e6fd
--define_symbol platform_set_irq_callback_table=0x0001e719
--define_symbol platform_set_rf_clk_source=0x0001e725
--define_symbol platform_set_rf_init_data=0x0001e731
--define_symbol platform_set_rf_power_mapping=0x0001e73d
--define_symbol platform_set_timer=0x0001e749
--define_symbol platform_shutdown=0x0001e74d
--define_symbol platform_switch_app=0x0001e751
--define_symbol platform_trace_raw=0x0001e77d
--define_symbol platform_write_persistent_reg=0x0001e795
--define_symbol printf_hexdump=0x0001e949
--define_symbol pvPortMalloc=0x0001f439
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f521
--define_symbol pvTimerGetTimerID=0x0001f539
--define_symbol pxPortInitialiseStack=0x0001f565
--define_symbol reverse_128=0x0001f745
--define_symbol reverse_24=0x0001f74b
--define_symbol reverse_48=0x0001f751
--define_symbol reverse_56=0x0001f757
--define_symbol reverse_64=0x0001f75d
--define_symbol reverse_bd_addr=0x0001f763
--define_symbol reverse_bytes=0x0001f769
--define_symbol sm_add_event_handler=0x0001fa29
--define_symbol sm_address_resolution_lookup=0x0001fb81
--define_symbol sm_authenticated=0x0001fee1
--define_symbol sm_authorization_decline=0x0001feef
--define_symbol sm_authorization_grant=0x0001ff0f
--define_symbol sm_authorization_state=0x0001ff2f
--define_symbol sm_bonding_decline=0x0001ff49
--define_symbol sm_config=0x00020369
--define_symbol sm_config_conn=0x00020381
--define_symbol sm_encryption_key_size=0x00020537
--define_symbol sm_just_works_confirm=0x00020a71
--define_symbol sm_le_device_key=0x00020dad
--define_symbol sm_passkey_input=0x00020e43
--define_symbol sm_private_random_address_generation_get=0x000211f1
--define_symbol sm_private_random_address_generation_get_mode=0x000211f9
--define_symbol sm_private_random_address_generation_set_mode=0x00021205
--define_symbol sm_private_random_address_generation_set_update_period=0x0002122d
--define_symbol sm_register_oob_data_callback=0x00021369
--define_symbol sm_request_pairing=0x00021375
--define_symbol sm_send_security_request=0x00021daf
--define_symbol sm_set_accepted_stk_generation_methods=0x00021dd5
--define_symbol sm_set_authentication_requirements=0x00021de1
--define_symbol sm_set_encryption_key_size_range=0x00021ded
--define_symbol sscanf_bd_addr=0x00022149
--define_symbol sysSetPublicDeviceAddr=0x000224fd
--define_symbol uuid128_to_str=0x00022c71
--define_symbol uuid_add_bluetooth_prefix=0x00022cc9
--define_symbol uuid_has_bluetooth_prefix=0x00022ce9
--define_symbol uxListRemove=0x00022d05
--define_symbol uxQueueMessagesWaiting=0x00022d2d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022d55
--define_symbol uxQueueSpacesAvailable=0x00022d71
--define_symbol uxTaskGetStackHighWaterMark=0x00022d9d
--define_symbol uxTaskPriorityGet=0x00022dbd
--define_symbol uxTaskPriorityGetFromISR=0x00022dd9
--define_symbol vListInitialise=0x00022e93
--define_symbol vListInitialiseItem=0x00022ea9
--define_symbol vListInsert=0x00022eaf
--define_symbol vListInsertEnd=0x00022edf
--define_symbol vPortEndScheduler=0x00022ef9
--define_symbol vPortEnterCritical=0x00022f25
--define_symbol vPortExitCritical=0x00022f69
--define_symbol vPortFree=0x00022f9d
--define_symbol vPortSuppressTicksAndSleep=0x00023031
--define_symbol vPortValidateInterruptPriority=0x00023159
--define_symbol vQueueDelete=0x000231b5
--define_symbol vQueueWaitForMessageRestricted=0x000231e1
--define_symbol vTaskDelay=0x00023229
--define_symbol vTaskInternalSetTimeOutState=0x00023275
--define_symbol vTaskMissedYield=0x00023285
--define_symbol vTaskPlaceOnEventList=0x00023291
--define_symbol vTaskPlaceOnEventListRestricted=0x000232c9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00023309
--define_symbol vTaskPrioritySet=0x000233b5
--define_symbol vTaskResume=0x0002347d
--define_symbol vTaskStartScheduler=0x00023501
--define_symbol vTaskStepTick=0x00023591
--define_symbol vTaskSuspend=0x000235c1
--define_symbol vTaskSuspendAll=0x0002367d
--define_symbol vTaskSwitchContext=0x0002368d
--define_symbol xPortStartScheduler=0x00023735
--define_symbol xQueueAddToSet=0x000237fd
--define_symbol xQueueCreateCountingSemaphore=0x00023821
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002385d
--define_symbol xQueueCreateMutex=0x000238a1
--define_symbol xQueueCreateMutexStatic=0x000238b7
--define_symbol xQueueCreateSet=0x000238d1
--define_symbol xQueueGenericCreate=0x000238d9
--define_symbol xQueueGenericCreateStatic=0x00023925
--define_symbol xQueueGenericReset=0x0002398d
--define_symbol xQueueGenericSend=0x00023a19
--define_symbol xQueueGenericSendFromISR=0x00023b85
--define_symbol xQueueGiveFromISR=0x00023c45
--define_symbol xQueueGiveMutexRecursive=0x00023ce9
--define_symbol xQueueIsQueueEmptyFromISR=0x00023d29
--define_symbol xQueueIsQueueFullFromISR=0x00023d4d
--define_symbol xQueuePeek=0x00023d75
--define_symbol xQueuePeekFromISR=0x00023e9d
--define_symbol xQueueReceive=0x00023f09
--define_symbol xQueueReceiveFromISR=0x00024035
--define_symbol xQueueRemoveFromSet=0x000240c9
--define_symbol xQueueSelectFromSet=0x000240eb
--define_symbol xQueueSelectFromSetFromISR=0x000240fd
--define_symbol xQueueSemaphoreTake=0x00024111
--define_symbol xQueueTakeMutexRecursive=0x0002427d
--define_symbol xTaskCheckForTimeOut=0x000242c1
--define_symbol xTaskCreate=0x00024331
--define_symbol xTaskCreateStatic=0x0002438d
--define_symbol xTaskGetCurrentTaskHandle=0x000243fd
--define_symbol xTaskGetSchedulerState=0x00024409
--define_symbol xTaskGetTickCount=0x00024425
--define_symbol xTaskGetTickCountFromISR=0x00024431
--define_symbol xTaskIncrementTick=0x00024441
--define_symbol xTaskPriorityDisinherit=0x0002450d
--define_symbol xTaskPriorityInherit=0x000245a1
--define_symbol xTaskRemoveFromEventList=0x00024635
--define_symbol xTaskResumeAll=0x000246b5
--define_symbol xTaskResumeFromISR=0x0002477d
--define_symbol xTimerCreate=0x00024809
--define_symbol xTimerCreateStatic=0x0002483d
--define_symbol xTimerCreateTimerTask=0x00024875
--define_symbol xTimerGenericCommand=0x000248e1
--define_symbol xTimerGetExpiryTime=0x00024951
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00024971
