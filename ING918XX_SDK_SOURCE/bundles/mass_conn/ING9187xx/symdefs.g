...
ll_free = 0x0000cb61;
ll_get_heap_free_size = 0x0000cb6d;
ll_hint_on_ce_len = 0x0000cb7d;
ll_legacy_adv_set_interval = 0x0000cbb5;
ll_malloc = 0x0000cbc5;
ll_query_timing_info = 0x0000ccfd;
ll_scan_set_fixed_channel = 0x0000cda1;
...
platform_enable_irq = 0x0001d2a1;
platform_get_current_task = 0x0001d2d9;
platform_get_gen_os_driver = 0x0001d2fd;
platform_get_heap_status = 0x0001d305;
platform_get_task_handle = 0x0001d31d;
platform_get_us_time = 0x0001d33d;
platform_get_version = 0x0001d341;
platform_hrng = 0x0001d349;
platform_install_isr_stack = 0x0001d351;
platform_install_task_stack = 0x0001d35d;
platform_patch_rf_init_data = 0x0001d395;
platform_printf = 0x0001d3a1;
platform_raise_assertion = 0x0001d3b5;
platform_rand = 0x0001d3c9;
platform_read_info = 0x0001d3cd;
platform_read_persistent_reg = 0x0001d3fd;
platform_reset = 0x0001d40d;
platform_set_evt_callback = 0x0001d431;
platform_set_evt_callback_table = 0x0001d445;
platform_set_irq_callback = 0x0001d451;
platform_set_irq_callback_table = 0x0001d46d;
platform_set_rf_clk_source = 0x0001d479;
platform_set_rf_init_data = 0x0001d485;
platform_set_rf_power_mapping = 0x0001d491;
platform_set_timer = 0x0001d49d;
platform_shutdown = 0x0001d4a1;
platform_switch_app = 0x0001d4a5;
platform_trace_raw = 0x0001d4d1;
platform_write_persistent_reg = 0x0001d4e9;
printf_hexdump = 0x0001d69d;
pvPortMalloc = 0x0001e18d;
pvTaskIncrementMutexHeldCount = 0x0001e275;
pvTimerGetTimerID = 0x0001e28d;
pxPortInitialiseStack = 0x0001e2b9;
reverse_128 = 0x0001e461;
reverse_24 = 0x0001e467;
reverse_48 = 0x0001e46d;
reverse_56 = 0x0001e473;
reverse_64 = 0x0001e479;
reverse_bd_addr = 0x0001e47f;
reverse_bytes = 0x0001e485;
sm_add_event_handler = 0x0001e5f1;
sm_address_resolution_lookup = 0x0001e749;
sm_authenticated = 0x0001eaa9;
sm_authorization_decline = 0x0001eab7;
sm_authorization_grant = 0x0001ead7;
sm_authorization_state = 0x0001eaf7;
sm_bonding_decline = 0x0001eb11;
sm_config = 0x0001ef31;
sm_config_conn = 0x0001ef49;
sm_encryption_key_size = 0x0001f0ff;
sm_just_works_confirm = 0x0001f639;
sm_le_device_key = 0x0001f975;
sm_passkey_input = 0x0001fa0b;
sm_private_random_address_generation_get = 0x0001fdb9;
sm_private_random_address_generation_get_mode = 0x0001fdc1;
sm_private_random_address_generation_set_mode = 0x0001fdcd;
sm_private_random_address_generation_set_update_period = 0x0001fdf5;
sm_register_oob_data_callback = 0x0001ff31;
sm_request_pairing = 0x0001ff3d;
sm_send_security_request = 0x00020977;
sm_set_accepted_stk_generation_methods = 0x0002099d;
sm_set_authentication_requirements = 0x000209a9;
sm_set_encryption_key_size_range = 0x000209b5;
sscanf_bd_addr = 0x00020d11;
sysSetPublicDeviceAddr = 0x000210c5;
uuid128_to_str = 0x000216a5;
uuid_add_bluetooth_prefix = 0x000216fd;
uuid_has_bluetooth_prefix = 0x0002171d;
uxListRemove = 0x00021739;
uxQueueMessagesWaiting = 0x00021761;
uxQueueMessagesWaitingFromISR = 0x00021789;
uxQueueSpacesAvailable = 0x000217a5;
uxTaskGetStackHighWaterMark = 0x000217d1;
uxTaskPriorityGet = 0x000217f1;
uxTaskPriorityGetFromISR = 0x0002180d;
vListInitialise = 0x000218c7;
vListInitialiseItem = 0x000218dd;
vListInsert = 0x000218e3;
vListInsertEnd = 0x00021913;
vPortEndScheduler = 0x0002192d;
vPortEnterCritical = 0x00021959;
vPortExitCritical = 0x0002199d;
vPortFree = 0x000219d1;
vPortSuppressTicksAndSleep = 0x00021a65;
vPortValidateInterruptPriority = 0x00021b8d;
vQueueDelete = 0x00021be9;
vQueueWaitForMessageRestricted = 0x00021c15;
vTaskDelay = 0x00021c5d;
vTaskInternalSetTimeOutState = 0x00021ca9;
vTaskMissedYield = 0x00021cb9;
vTaskPlaceOnEventList = 0x00021cc5;
vTaskPlaceOnEventListRestricted = 0x00021cfd;
vTaskPriorityDisinheritAfterTimeout = 0x00021d3d;
vTaskPrioritySet = 0x00021de9;
vTaskResume = 0x00021eb1;
vTaskStartScheduler = 0x00021f35;
vTaskStepTick = 0x00021fc5;
vTaskSuspend = 0x00021ff5;
vTaskSuspendAll = 0x000220b1;
vTaskSwitchContext = 0x000220c1;
xPortStartScheduler = 0x00022169;
xQueueAddToSet = 0x00022231;
xQueueCreateCountingSemaphore = 0x00022255;
xQueueCreateCountingSemaphoreStatic = 0x00022291;
xQueueCreateMutex = 0x000222d5;
xQueueCreateMutexStatic = 0x000222eb;
xQueueCreateSet = 0x00022305;
xQueueGenericCreate = 0x0002230d;
xQueueGenericCreateStatic = 0x00022359;
xQueueGenericReset = 0x000223c1;
xQueueGenericSend = 0x0002244d;
xQueueGenericSendFromISR = 0x000225b9;
xQueueGiveFromISR = 0x00022679;
xQueueGiveMutexRecursive = 0x0002271d;
xQueueIsQueueEmptyFromISR = 0x0002275d;
xQueueIsQueueFullFromISR = 0x00022781;
xQueuePeek = 0x000227a9;
xQueuePeekFromISR = 0x000228d1;
xQueueReceive = 0x0002293d;
xQueueReceiveFromISR = 0x00022a69;
xQueueRemoveFromSet = 0x00022afd;
xQueueSelectFromSet = 0x00022b1f;
xQueueSelectFromSetFromISR = 0x00022b31;
xQueueSemaphoreTake = 0x00022b45;
xQueueTakeMutexRecursive = 0x00022cb1;
xTaskCheckForTimeOut = 0x00022cf5;
xTaskCreate = 0x00022d65;
xTaskCreateStatic = 0x00022dc1;
xTaskGetCurrentTaskHandle = 0x00022e31;
xTaskGetSchedulerState = 0x00022e3d;
xTaskGetTickCount = 0x00022e59;
xTaskGetTickCountFromISR = 0x00022e65;
xTaskIncrementTick = 0x00022e75;
xTaskPriorityDisinherit = 0x00022f41;
xTaskPriorityInherit = 0x00022fd5;
xTaskRemoveFromEventList = 0x00023069;
xTaskResumeAll = 0x000230e9;
xTaskResumeFromISR = 0x000231b1;
xTimerCreate = 0x0002323d;
xTimerCreateStatic = 0x00023271;
xTimerCreateTimerTask = 0x000232a9;
xTimerGenericCommand = 0x00023315;
xTimerGetExpiryTime = 0x00023385;
xTimerGetTimerDaemonTaskHandle = 0x000233a5;
