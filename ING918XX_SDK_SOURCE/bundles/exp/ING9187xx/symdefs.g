...
ll_config = 0x0000cf31;
ll_dhkey_generated = 0x0000d15d;
ll_free = 0x0000d18d;
ll_get_conn_events_info = 0x0000d199;
ll_get_conn_info = 0x0000d275;
ll_get_heap_free_size = 0x0000d2b5;
ll_hint_on_ce_len = 0x0000d2c5;
ll_install_ecc_engine = 0x0000d2fd;
ll_legacy_adv_set_interval = 0x0000d309;
ll_lock_frequency = 0x0000d319;
ll_malloc = 0x0000d371;
ll_p256_key_pair_generated = 0x0000d379;
ll_raw_packet_alloc = 0x0000d529;
ll_raw_packet_free = 0x0000d5fd;
ll_raw_packet_get_bare_rx_data = 0x0000d627;
ll_raw_packet_get_rx_data = 0x0000d6ed;
ll_raw_packet_recv = 0x0000d78d;
ll_raw_packet_send = 0x0000d849;
ll_raw_packet_set_bare_data = 0x0000d931;
ll_raw_packet_set_bare_mode = 0x0000d96f;
ll_raw_packet_set_param = 0x0000da75;
ll_raw_packet_set_tx_data = 0x0000dad3;
ll_scan_set_fixed_channel = 0x0000db91;
ll_set_adv_access_address = 0x0000dd89;
ll_set_adv_coded_scheme = 0x0000dd95;
ll_set_conn_coded_scheme = 0x0000ddc5;
ll_set_conn_interval_unit = 0x0000ddf1;
ll_set_conn_latency = 0x0000ddfd;
ll_set_conn_tx_power = 0x0000de2d;
ll_set_def_antenna = 0x0000de69;
ll_set_initiating_coded_scheme = 0x0000de85;
ll_set_max_conn_number = 0x0000de91;
ll_set_tx_power_range = 0x0000df2d;
ll_unlock_frequency = 0x0000df55;
nibble_for_char = 0x0001f571;
platform_32k_rc_auto_tune = 0x0001f621;
platform_32k_rc_tune = 0x0001f69d;
platform_calibrate_32k = 0x0001f6b1;
platform_config = 0x0001f6b5;
platform_enable_irq = 0x0001f7dd;
platform_get_current_task = 0x0001f815;
platform_get_gen_os_driver = 0x0001f839;
platform_get_heap_status = 0x0001f841;
platform_get_task_handle = 0x0001f859;
platform_get_us_time = 0x0001f879;
platform_get_version = 0x0001f87d;
platform_hrng = 0x0001f885;
platform_install_isr_stack = 0x0001f88d;
platform_install_task_stack = 0x0001f899;
platform_patch_rf_init_data = 0x0001f8d1;
platform_printf = 0x0001f8dd;
platform_raise_assertion = 0x0001f8f1;
platform_rand = 0x0001f905;
platform_read_info = 0x0001f909;
platform_read_persistent_reg = 0x0001f939;
platform_reset = 0x0001f949;
platform_set_evt_callback = 0x0001f96d;
platform_set_evt_callback_table = 0x0001f981;
platform_set_irq_callback = 0x0001f98d;
platform_set_irq_callback_table = 0x0001f9a9;
platform_set_rf_clk_source = 0x0001f9b5;
platform_set_rf_init_data = 0x0001f9c1;
platform_set_rf_power_mapping = 0x0001f9cd;
platform_set_timer = 0x0001f9d9;
platform_shutdown = 0x0001f9dd;
platform_switch_app = 0x0001f9e1;
platform_trace_raw = 0x0001fa0d;
platform_write_persistent_reg = 0x0001fa25;
printf_hexdump = 0x0001fbd9;
pvPortMalloc = 0x000206c9;
pvTaskIncrementMutexHeldCount = 0x000207b1;
pvTimerGetTimerID = 0x000207c9;
pxPortInitialiseStack = 0x000207f5;
reverse_128 = 0x0002099d;
reverse_24 = 0x000209a3;
reverse_48 = 0x000209a9;
reverse_56 = 0x000209af;
reverse_64 = 0x000209b5;
reverse_bd_addr = 0x000209bb;
reverse_bytes = 0x000209c1;
sm_add_event_handler = 0x00020b6d;
sm_address_resolution_lookup = 0x00020cc5;
sm_authenticated = 0x00021025;
sm_authorization_decline = 0x00021033;
sm_authorization_grant = 0x00021053;
sm_authorization_state = 0x00021073;
sm_bonding_decline = 0x0002108d;
sm_config = 0x000214ad;
sm_config_conn = 0x000214c5;
sm_encryption_key_size = 0x0002167b;
sm_just_works_confirm = 0x00021bb5;
sm_le_device_key = 0x00021ef1;
sm_passkey_input = 0x00021f87;
sm_private_random_address_generation_get = 0x00022335;
sm_private_random_address_generation_get_mode = 0x0002233d;
sm_private_random_address_generation_set_mode = 0x00022349;
sm_private_random_address_generation_set_update_period = 0x00022371;
sm_register_oob_data_callback = 0x000224ad;
sm_request_pairing = 0x000224b9;
sm_send_security_request = 0x00022ef3;
sm_set_accepted_stk_generation_methods = 0x00022f19;
sm_set_authentication_requirements = 0x00022f25;
sm_set_encryption_key_size_range = 0x00022f31;
sscanf_bd_addr = 0x00023301;
sysSetPublicDeviceAddr = 0x000236b5;
uuid128_to_str = 0x00023cbd;
uuid_add_bluetooth_prefix = 0x00023d15;
uuid_has_bluetooth_prefix = 0x00023d35;
uxListRemove = 0x00023d51;
uxQueueMessagesWaiting = 0x00023d79;
uxQueueMessagesWaitingFromISR = 0x00023da1;
uxQueueSpacesAvailable = 0x00023dbd;
uxTaskGetStackHighWaterMark = 0x00023de9;
uxTaskPriorityGet = 0x00023e09;
uxTaskPriorityGetFromISR = 0x00023e25;
vListInitialise = 0x00023edf;
vListInitialiseItem = 0x00023ef5;
vListInsert = 0x00023efb;
vListInsertEnd = 0x00023f2b;
vPortEndScheduler = 0x00023f45;
vPortEnterCritical = 0x00023f71;
vPortExitCritical = 0x00023fb5;
vPortFree = 0x00023fe9;
vPortSuppressTicksAndSleep = 0x0002407d;
vPortValidateInterruptPriority = 0x000241a5;
vQueueDelete = 0x00024201;
vQueueWaitForMessageRestricted = 0x0002422d;
vTaskDelay = 0x00024275;
vTaskInternalSetTimeOutState = 0x000242c1;
vTaskMissedYield = 0x000242d1;
vTaskPlaceOnEventList = 0x000242dd;
vTaskPlaceOnEventListRestricted = 0x00024315;
vTaskPriorityDisinheritAfterTimeout = 0x00024355;
vTaskPrioritySet = 0x00024401;
vTaskResume = 0x000244c9;
vTaskStartScheduler = 0x0002454d;
vTaskStepTick = 0x000245dd;
vTaskSuspend = 0x0002460d;
vTaskSuspendAll = 0x000246c9;
vTaskSwitchContext = 0x000246d9;
xPortStartScheduler = 0x00024781;
xQueueAddToSet = 0x00024849;
xQueueCreateCountingSemaphore = 0x0002486d;
xQueueCreateCountingSemaphoreStatic = 0x000248a9;
xQueueCreateMutex = 0x000248ed;
xQueueCreateMutexStatic = 0x00024903;
xQueueCreateSet = 0x0002491d;
xQueueGenericCreate = 0x00024925;
xQueueGenericCreateStatic = 0x00024971;
xQueueGenericReset = 0x000249d9;
xQueueGenericSend = 0x00024a65;
xQueueGenericSendFromISR = 0x00024bd1;
xQueueGiveFromISR = 0x00024c91;
xQueueGiveMutexRecursive = 0x00024d35;
xQueueIsQueueEmptyFromISR = 0x00024d75;
xQueueIsQueueFullFromISR = 0x00024d99;
xQueuePeek = 0x00024dc1;
xQueuePeekFromISR = 0x00024ee9;
xQueueReceive = 0x00024f55;
xQueueReceiveFromISR = 0x00025081;
xQueueRemoveFromSet = 0x00025115;
xQueueSelectFromSet = 0x00025137;
xQueueSelectFromSetFromISR = 0x00025149;
xQueueSemaphoreTake = 0x0002515d;
xQueueTakeMutexRecursive = 0x000252c9;
xTaskCheckForTimeOut = 0x0002530d;
xTaskCreate = 0x0002537d;
xTaskCreateStatic = 0x000253d9;
xTaskGetCurrentTaskHandle = 0x00025449;
xTaskGetSchedulerState = 0x00025455;
xTaskGetTickCount = 0x00025471;
xTaskGetTickCountFromISR = 0x0002547d;
xTaskIncrementTick = 0x0002548d;
xTaskPriorityDisinherit = 0x00025559;
xTaskPriorityInherit = 0x000255ed;
xTaskRemoveFromEventList = 0x00025681;
xTaskResumeAll = 0x00025701;
xTaskResumeFromISR = 0x000257c9;
xTimerCreate = 0x00025855;
xTimerCreateStatic = 0x00025889;
xTimerCreateTimerTask = 0x000258c1;
xTimerGenericCommand = 0x0002592d;
xTimerGetExpiryTime = 0x0002599d;
xTimerGetTimerDaemonTaskHandle = 0x000259bd;
