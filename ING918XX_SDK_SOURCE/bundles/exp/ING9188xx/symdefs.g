...
ll_config = 0x0000d325;
ll_dhkey_generated = 0x0000d551;
ll_free = 0x0000d581;
ll_get_conn_events_info = 0x0000d58d;
ll_get_conn_info = 0x0000d669;
ll_get_heap_free_size = 0x0000d6a9;
ll_hint_on_ce_len = 0x0000d6b9;
ll_install_ecc_engine = 0x0000d6f1;
ll_legacy_adv_set_interval = 0x0000d6fd;
ll_lock_frequency = 0x0000d70d;
ll_malloc = 0x0000d765;
ll_p256_key_pair_generated = 0x0000d76d;
ll_raw_packet_alloc = 0x0000d91d;
ll_raw_packet_free = 0x0000d9f1;
ll_raw_packet_get_bare_rx_data = 0x0000da1b;
ll_raw_packet_get_iq_samples = 0x0000dae1;
ll_raw_packet_get_rx_data = 0x0000db7b;
ll_raw_packet_recv = 0x0000dc1d;
ll_raw_packet_send = 0x0000dcd9;
ll_raw_packet_set_bare_data = 0x0000ddc1;
ll_raw_packet_set_bare_mode = 0x0000ddff;
ll_raw_packet_set_fake_cte_info = 0x0000df05;
ll_raw_packet_set_param = 0x0000df27;
ll_raw_packet_set_rx_cte = 0x0000df85;
ll_raw_packet_set_tx_cte = 0x0000e01b;
ll_raw_packet_set_tx_data = 0x0000e059;
ll_scan_set_fixed_channel = 0x0000e115;
ll_scanner_enable_iq_sampling = 0x0000e121;
ll_set_adv_access_address = 0x0000e3b5;
ll_set_adv_coded_scheme = 0x0000e3c1;
...
ll_set_def_antenna = 0x0000e495;
ll_set_initiating_coded_scheme = 0x0000e4b1;
ll_set_max_conn_number = 0x0000e4bd;
ll_set_tx_power_range = 0x0000e559;
ll_unlock_frequency = 0x0000e581;
nibble_for_char = 0x00020ba9;
platform_32k_rc_auto_tune = 0x00020c59;
platform_32k_rc_tune = 0x00020cd5;
platform_calibrate_32k = 0x00020ce9;
platform_config = 0x00020ced;
platform_enable_irq = 0x00020e15;
platform_get_current_task = 0x00020e4d;
platform_get_gen_os_driver = 0x00020e71;
platform_get_heap_status = 0x00020e79;
platform_get_task_handle = 0x00020e91;
platform_get_us_time = 0x00020eb1;
platform_get_version = 0x00020eb5;
platform_hrng = 0x00020ebd;
platform_install_isr_stack = 0x00020ec5;
platform_install_task_stack = 0x00020ed1;
platform_patch_rf_init_data = 0x00020f09;
platform_printf = 0x00020f15;
platform_raise_assertion = 0x00020f29;
platform_rand = 0x00020f3d;
platform_read_info = 0x00020f41;
platform_read_persistent_reg = 0x00020f71;
platform_reset = 0x00020f81;
platform_set_evt_callback = 0x00020fa5;
platform_set_evt_callback_table = 0x00020fb9;
platform_set_irq_callback = 0x00020fc5;
platform_set_irq_callback_table = 0x00020fe1;
platform_set_rf_clk_source = 0x00020fed;
platform_set_rf_init_data = 0x00020ff9;
platform_set_rf_power_mapping = 0x00021005;
platform_set_timer = 0x00021011;
platform_shutdown = 0x00021015;
platform_switch_app = 0x00021019;
platform_trace_raw = 0x00021045;
platform_write_persistent_reg = 0x0002105d;
printf_hexdump = 0x00021211;
pvPortMalloc = 0x00021d01;
pvTaskIncrementMutexHeldCount = 0x00021de9;
pvTimerGetTimerID = 0x00021e01;
pxPortInitialiseStack = 0x00021e2d;
reverse_128 = 0x0002200d;
reverse_24 = 0x00022013;
reverse_48 = 0x00022019;
reverse_56 = 0x0002201f;
reverse_64 = 0x00022025;
reverse_bd_addr = 0x0002202b;
reverse_bytes = 0x00022031;
sm_add_event_handler = 0x00022331;
sm_address_resolution_lookup = 0x00022489;
sm_authenticated = 0x000227e9;
sm_authorization_decline = 0x000227f7;
sm_authorization_grant = 0x00022817;
sm_authorization_state = 0x00022837;
sm_bonding_decline = 0x00022851;
sm_config = 0x00022c71;
sm_config_conn = 0x00022c89;
sm_encryption_key_size = 0x00022e3f;
sm_just_works_confirm = 0x00023379;
sm_le_device_key = 0x000236b5;
sm_passkey_input = 0x0002374b;
sm_private_random_address_generation_get = 0x00023af9;
sm_private_random_address_generation_get_mode = 0x00023b01;
sm_private_random_address_generation_set_mode = 0x00023b0d;
sm_private_random_address_generation_set_update_period = 0x00023b35;
sm_register_oob_data_callback = 0x00023c71;
sm_request_pairing = 0x00023c7d;
sm_send_security_request = 0x000246b7;
sm_set_accepted_stk_generation_methods = 0x000246dd;
sm_set_authentication_requirements = 0x000246e9;
sm_set_encryption_key_size_range = 0x000246f5;
sscanf_bd_addr = 0x00024ac5;
sysSetPublicDeviceAddr = 0x00024e79;
uuid128_to_str = 0x00025615;
uuid_add_bluetooth_prefix = 0x0002566d;
uuid_has_bluetooth_prefix = 0x0002568d;
uxListRemove = 0x000256a9;
uxQueueMessagesWaiting = 0x000256d1;
uxQueueMessagesWaitingFromISR = 0x000256f9;
uxQueueSpacesAvailable = 0x00025715;
uxTaskGetStackHighWaterMark = 0x00025741;
uxTaskPriorityGet = 0x00025761;
uxTaskPriorityGetFromISR = 0x0002577d;
vListInitialise = 0x00025837;
vListInitialiseItem = 0x0002584d;
vListInsert = 0x00025853;
vListInsertEnd = 0x00025883;
vPortEndScheduler = 0x0002589d;
vPortEnterCritical = 0x000258c9;
vPortExitCritical = 0x0002590d;
vPortFree = 0x00025941;
vPortSuppressTicksAndSleep = 0x000259d5;
vPortValidateInterruptPriority = 0x00025afd;
vQueueDelete = 0x00025b59;
vQueueWaitForMessageRestricted = 0x00025b85;
vTaskDelay = 0x00025bcd;
vTaskInternalSetTimeOutState = 0x00025c19;
vTaskMissedYield = 0x00025c29;
vTaskPlaceOnEventList = 0x00025c35;
vTaskPlaceOnEventListRestricted = 0x00025c6d;
vTaskPriorityDisinheritAfterTimeout = 0x00025cad;
vTaskPrioritySet = 0x00025d59;
vTaskResume = 0x00025e21;
vTaskStartScheduler = 0x00025ea5;
vTaskStepTick = 0x00025f35;
vTaskSuspend = 0x00025f65;
vTaskSuspendAll = 0x00026021;
vTaskSwitchContext = 0x00026031;
xPortStartScheduler = 0x000260d9;
xQueueAddToSet = 0x000261a1;
xQueueCreateCountingSemaphore = 0x000261c5;
xQueueCreateCountingSemaphoreStatic = 0x00026201;
xQueueCreateMutex = 0x00026245;
xQueueCreateMutexStatic = 0x0002625b;
xQueueCreateSet = 0x00026275;
xQueueGenericCreate = 0x0002627d;
xQueueGenericCreateStatic = 0x000262c9;
xQueueGenericReset = 0x00026331;
xQueueGenericSend = 0x000263bd;
xQueueGenericSendFromISR = 0x00026529;
xQueueGiveFromISR = 0x000265e9;
xQueueGiveMutexRecursive = 0x0002668d;
xQueueIsQueueEmptyFromISR = 0x000266cd;
xQueueIsQueueFullFromISR = 0x000266f1;
xQueuePeek = 0x00026719;
xQueuePeekFromISR = 0x00026841;
xQueueReceive = 0x000268ad;
xQueueReceiveFromISR = 0x000269d9;
xQueueRemoveFromSet = 0x00026a6d;
xQueueSelectFromSet = 0x00026a8f;
xQueueSelectFromSetFromISR = 0x00026aa1;
xQueueSemaphoreTake = 0x00026ab5;
xQueueTakeMutexRecursive = 0x00026c21;
xTaskCheckForTimeOut = 0x00026c65;
xTaskCreate = 0x00026cd5;
xTaskCreateStatic = 0x00026d31;
xTaskGetCurrentTaskHandle = 0x00026da1;
xTaskGetSchedulerState = 0x00026dad;
xTaskGetTickCount = 0x00026dc9;
xTaskGetTickCountFromISR = 0x00026dd5;
xTaskIncrementTick = 0x00026de5;
xTaskPriorityDisinherit = 0x00026eb1;
xTaskPriorityInherit = 0x00026f45;
xTaskRemoveFromEventList = 0x00026fd9;
xTaskResumeAll = 0x00027059;
xTaskResumeFromISR = 0x00027121;
xTimerCreate = 0x000271ad;
xTimerCreateStatic = 0x000271e1;
xTimerCreateTimerTask = 0x00027219;
xTimerGenericCommand = 0x00027285;
xTimerGetExpiryTime = 0x000272f5;
xTimerGetTimerDaemonTaskHandle = 0x00027315;
