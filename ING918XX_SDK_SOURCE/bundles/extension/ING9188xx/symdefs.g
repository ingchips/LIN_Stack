...
ll_config = 0x0000d311;
ll_free = 0x0000d321;
ll_get_heap_free_size = 0x0000d32d;
ll_hint_on_ce_len = 0x0000d33d;
ll_legacy_adv_set_interval = 0x0000d375;
ll_lock_frequency = 0x0000d385;
...
ll_raw_packet_recv = 0x0000d861;
ll_raw_packet_send = 0x0000d91d;
ll_raw_packet_set_bare_data = 0x0000da05;
ll_raw_packet_set_bare_mode = 0x0000da43;
ll_raw_packet_set_fake_cte_info = 0x0000db49;
ll_raw_packet_set_param = 0x0000db6b;
ll_raw_packet_set_rx_cte = 0x0000dbc9;
ll_raw_packet_set_tx_cte = 0x0000dc5f;
ll_raw_packet_set_tx_data = 0x0000dc9d;
ll_scan_set_fixed_channel = 0x0000dd59;
ll_scanner_enable_iq_sampling = 0x0000dd65;
ll_set_adv_access_address = 0x0000dff9;
ll_set_adv_coded_scheme = 0x0000e005;
ll_set_conn_coded_scheme = 0x0000e035;
ll_set_conn_interval_unit = 0x0000e061;
ll_set_conn_latency = 0x0000e06d;
ll_set_conn_tx_power = 0x0000e09d;
ll_set_def_antenna = 0x0000e0e5;
ll_set_initiating_coded_scheme = 0x0000e101;
ll_set_max_conn_number = 0x0000e10d;
ll_unlock_frequency = 0x0000e1a9;
nibble_for_char = 0x0001f1d5;
platform_32k_rc_auto_tune = 0x0001f281;
platform_32k_rc_tune = 0x0001f2fd;
platform_calibrate_32k = 0x0001f311;
platform_config = 0x0001f315;
platform_enable_irq = 0x0001f43d;
platform_get_current_task = 0x0001f475;
platform_get_gen_os_driver = 0x0001f499;
platform_get_heap_status = 0x0001f4a1;
platform_get_task_handle = 0x0001f4b9;
platform_get_us_time = 0x0001f4d9;
platform_get_version = 0x0001f4dd;
platform_hrng = 0x0001f4e5;
platform_install_isr_stack = 0x0001f4ed;
platform_install_task_stack = 0x0001f4f9;
platform_patch_rf_init_data = 0x0001f531;
platform_printf = 0x0001f53d;
platform_raise_assertion = 0x0001f551;
platform_rand = 0x0001f565;
platform_read_info = 0x0001f569;
platform_read_persistent_reg = 0x0001f599;
platform_reset = 0x0001f5a9;
platform_set_evt_callback = 0x0001f5cd;
platform_set_evt_callback_table = 0x0001f5e1;
platform_set_irq_callback = 0x0001f5ed;
platform_set_irq_callback_table = 0x0001f609;
platform_set_rf_clk_source = 0x0001f615;
platform_set_rf_init_data = 0x0001f621;
platform_set_rf_power_mapping = 0x0001f62d;
platform_set_timer = 0x0001f639;
platform_shutdown = 0x0001f63d;
platform_switch_app = 0x0001f641;
platform_trace_raw = 0x0001f66d;
platform_write_persistent_reg = 0x0001f685;
printf_hexdump = 0x0001f839;
pvPortMalloc = 0x00020329;
pvTaskIncrementMutexHeldCount = 0x00020411;
pvTimerGetTimerID = 0x00020429;
pxPortInitialiseStack = 0x00020455;
reverse_128 = 0x00020635;
reverse_24 = 0x0002063b;
reverse_48 = 0x00020641;
reverse_56 = 0x00020647;
reverse_64 = 0x0002064d;
reverse_bd_addr = 0x00020653;
reverse_bytes = 0x00020659;
sm_add_event_handler = 0x00020939;
sm_address_resolution_lookup = 0x00020a91;
sm_authenticated = 0x00020df1;
sm_authorization_decline = 0x00020dff;
sm_authorization_grant = 0x00020e1f;
sm_authorization_state = 0x00020e3f;
sm_bonding_decline = 0x00020e59;
sm_config = 0x00021279;
sm_config_conn = 0x00021291;
sm_encryption_key_size = 0x00021447;
sm_just_works_confirm = 0x00021981;
sm_le_device_key = 0x00021cbd;
sm_passkey_input = 0x00021d53;
sm_private_random_address_generation_get = 0x00022101;
sm_private_random_address_generation_get_mode = 0x00022109;
sm_private_random_address_generation_set_mode = 0x00022115;
sm_private_random_address_generation_set_update_period = 0x0002213d;
sm_register_oob_data_callback = 0x00022279;
sm_request_pairing = 0x00022285;
sm_send_security_request = 0x00022cbf;
sm_set_accepted_stk_generation_methods = 0x00022ce5;
sm_set_authentication_requirements = 0x00022cf1;
sm_set_encryption_key_size_range = 0x00022cfd;
sscanf_bd_addr = 0x000230cd;
sysSetPublicDeviceAddr = 0x00023481;
uuid128_to_str = 0x00023bf5;
uuid_add_bluetooth_prefix = 0x00023c4d;
uuid_has_bluetooth_prefix = 0x00023c6d;
uxListRemove = 0x00023c89;
uxQueueMessagesWaiting = 0x00023cb1;
uxQueueMessagesWaitingFromISR = 0x00023cd9;
uxQueueSpacesAvailable = 0x00023cf5;
uxTaskGetStackHighWaterMark = 0x00023d21;
uxTaskPriorityGet = 0x00023d41;
uxTaskPriorityGetFromISR = 0x00023d5d;
vListInitialise = 0x00023e17;
vListInitialiseItem = 0x00023e2d;
vListInsert = 0x00023e33;
vListInsertEnd = 0x00023e63;
vPortEndScheduler = 0x00023e7d;
vPortEnterCritical = 0x00023ea9;
vPortExitCritical = 0x00023eed;
vPortFree = 0x00023f21;
vPortSuppressTicksAndSleep = 0x00023fb5;
vPortValidateInterruptPriority = 0x000240dd;
vQueueDelete = 0x00024139;
vQueueWaitForMessageRestricted = 0x00024165;
vTaskDelay = 0x000241ad;
vTaskInternalSetTimeOutState = 0x000241f9;
vTaskMissedYield = 0x00024209;
vTaskPlaceOnEventList = 0x00024215;
vTaskPlaceOnEventListRestricted = 0x0002424d;
vTaskPriorityDisinheritAfterTimeout = 0x0002428d;
vTaskPrioritySet = 0x00024339;
vTaskResume = 0x00024401;
vTaskStartScheduler = 0x00024485;
vTaskStepTick = 0x00024515;
vTaskSuspend = 0x00024545;
vTaskSuspendAll = 0x00024601;
vTaskSwitchContext = 0x00024611;
xPortStartScheduler = 0x000246b9;
xQueueAddToSet = 0x00024781;
xQueueCreateCountingSemaphore = 0x000247a5;
xQueueCreateCountingSemaphoreStatic = 0x000247e1;
xQueueCreateMutex = 0x00024825;
xQueueCreateMutexStatic = 0x0002483b;
xQueueCreateSet = 0x00024855;
xQueueGenericCreate = 0x0002485d;
xQueueGenericCreateStatic = 0x000248a9;
xQueueGenericReset = 0x00024911;
xQueueGenericSend = 0x0002499d;
xQueueGenericSendFromISR = 0x00024b09;
xQueueGiveFromISR = 0x00024bc9;
xQueueGiveMutexRecursive = 0x00024c6d;
xQueueIsQueueEmptyFromISR = 0x00024cad;
xQueueIsQueueFullFromISR = 0x00024cd1;
xQueuePeek = 0x00024cf9;
xQueuePeekFromISR = 0x00024e21;
xQueueReceive = 0x00024e8d;
xQueueReceiveFromISR = 0x00024fb9;
xQueueRemoveFromSet = 0x0002504d;
xQueueSelectFromSet = 0x0002506f;
xQueueSelectFromSetFromISR = 0x00025081;
xQueueSemaphoreTake = 0x00025095;
xQueueTakeMutexRecursive = 0x00025201;
xTaskCheckForTimeOut = 0x00025245;
xTaskCreate = 0x000252b5;
xTaskCreateStatic = 0x00025311;
xTaskGetCurrentTaskHandle = 0x00025381;
xTaskGetSchedulerState = 0x0002538d;
xTaskGetTickCount = 0x000253a9;
xTaskGetTickCountFromISR = 0x000253b5;
xTaskIncrementTick = 0x000253c5;
xTaskPriorityDisinherit = 0x00025491;
xTaskPriorityInherit = 0x00025525;
xTaskRemoveFromEventList = 0x000255b9;
xTaskResumeAll = 0x00025639;
xTaskResumeFromISR = 0x00025701;
xTimerCreate = 0x0002578d;
xTimerCreateStatic = 0x000257c1;
xTimerCreateTimerTask = 0x000257f9;
xTimerGenericCommand = 0x00025865;
xTimerGetExpiryTime = 0x000258d5;
xTimerGetTimerDaemonTaskHandle = 0x000258f5;
