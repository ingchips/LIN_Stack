...
ll_config = 0x0000cd85;
ll_free = 0x0000cd95;
ll_get_heap_free_size = 0x0000cda1;
ll_hint_on_ce_len = 0x0000cdb1;
ll_legacy_adv_set_interval = 0x0000cde9;
ll_lock_frequency = 0x0000cdf9;
ll_malloc = 0x0000ce51;
ll_query_timing_info = 0x0000cf89;
ll_raw_packet_alloc = 0x0000cfd5;
ll_raw_packet_free = 0x0000d0a9;
ll_raw_packet_get_bare_rx_data = 0x0000d0d3;
ll_raw_packet_get_rx_data = 0x0000d199;
ll_raw_packet_recv = 0x0000d239;
ll_raw_packet_send = 0x0000d2f5;
ll_raw_packet_set_bare_data = 0x0000d3dd;
ll_raw_packet_set_bare_mode = 0x0000d41b;
ll_raw_packet_set_param = 0x0000d521;
ll_raw_packet_set_tx_data = 0x0000d57f;
ll_scan_set_fixed_channel = 0x0000d63d;
ll_set_adv_access_address = 0x0000d835;
ll_set_adv_coded_scheme = 0x0000d841;
ll_set_conn_coded_scheme = 0x0000d871;
ll_set_conn_interval_unit = 0x0000d89d;
ll_set_conn_latency = 0x0000d8a9;
ll_set_conn_tx_power = 0x0000d8d9;
ll_set_def_antenna = 0x0000d921;
ll_set_initiating_coded_scheme = 0x0000d93d;
ll_set_max_conn_number = 0x0000d949;
ll_unlock_frequency = 0x0000d9e5;
nibble_for_char = 0x0001da31;
platform_32k_rc_auto_tune = 0x0001dadd;
platform_32k_rc_tune = 0x0001db59;
platform_calibrate_32k = 0x0001db6d;
platform_config = 0x0001db71;
platform_enable_irq = 0x0001dc99;
platform_get_current_task = 0x0001dcd1;
platform_get_gen_os_driver = 0x0001dcf5;
platform_get_heap_status = 0x0001dcfd;
platform_get_task_handle = 0x0001dd15;
platform_get_us_time = 0x0001dd35;
platform_get_version = 0x0001dd39;
platform_hrng = 0x0001dd41;
platform_install_isr_stack = 0x0001dd49;
platform_install_task_stack = 0x0001dd55;
platform_patch_rf_init_data = 0x0001dd8d;
platform_printf = 0x0001dd99;
platform_raise_assertion = 0x0001ddad;
platform_rand = 0x0001ddc1;
platform_read_info = 0x0001ddc5;
platform_read_persistent_reg = 0x0001ddf5;
platform_reset = 0x0001de05;
platform_set_evt_callback = 0x0001de29;
platform_set_evt_callback_table = 0x0001de3d;
platform_set_irq_callback = 0x0001de49;
platform_set_irq_callback_table = 0x0001de65;
platform_set_rf_clk_source = 0x0001de71;
platform_set_rf_init_data = 0x0001de7d;
platform_set_rf_power_mapping = 0x0001de89;
platform_set_timer = 0x0001de95;
platform_shutdown = 0x0001de99;
platform_switch_app = 0x0001de9d;
platform_trace_raw = 0x0001dec9;
platform_write_persistent_reg = 0x0001dee1;
printf_hexdump = 0x0001e095;
pvPortMalloc = 0x0001eb85;
pvTaskIncrementMutexHeldCount = 0x0001ec6d;
pvTimerGetTimerID = 0x0001ec85;
pxPortInitialiseStack = 0x0001ecb1;
reverse_128 = 0x0001ee59;
reverse_24 = 0x0001ee5f;
reverse_48 = 0x0001ee65;
reverse_56 = 0x0001ee6b;
reverse_64 = 0x0001ee71;
reverse_bd_addr = 0x0001ee77;
reverse_bytes = 0x0001ee7d;
sm_add_event_handler = 0x0001f009;
sm_address_resolution_lookup = 0x0001f161;
sm_authenticated = 0x0001f4c1;
sm_authorization_decline = 0x0001f4cf;
sm_authorization_grant = 0x0001f4ef;
sm_authorization_state = 0x0001f50f;
sm_bonding_decline = 0x0001f529;
sm_config = 0x0001f949;
sm_config_conn = 0x0001f961;
sm_encryption_key_size = 0x0001fb17;
sm_just_works_confirm = 0x00020051;
sm_le_device_key = 0x0002038d;
sm_passkey_input = 0x00020423;
...
sm_register_oob_data_callback = 0x00020949;
sm_request_pairing = 0x00020955;
sm_send_security_request = 0x0002138f;
sm_set_accepted_stk_generation_methods = 0x000213b5;
sm_set_authentication_requirements = 0x000213c1;
sm_set_encryption_key_size_range = 0x000213cd;
sscanf_bd_addr = 0x0002179d;
...
uxTaskPriorityGet = 0x0002227d;
uxTaskPriorityGetFromISR = 0x00022299;
vListInitialise = 0x00022353;
vListInitialiseItem = 0x00022369;
vListInsert = 0x0002236f;
vListInsertEnd = 0x0002239f;
vPortEndScheduler = 0x000223b9;
vPortEnterCritical = 0x000223e5;
vPortExitCritical = 0x00022429;
vPortFree = 0x0002245d;
vPortSuppressTicksAndSleep = 0x000224f1;
vPortValidateInterruptPriority = 0x00022619;
vQueueDelete = 0x00022675;
vQueueWaitForMessageRestricted = 0x000226a1;
vTaskDelay = 0x000226e9;
vTaskInternalSetTimeOutState = 0x00022735;
vTaskMissedYield = 0x00022745;
vTaskPlaceOnEventList = 0x00022751;
vTaskPlaceOnEventListRestricted = 0x00022789;
vTaskPriorityDisinheritAfterTimeout = 0x000227c9;
vTaskPrioritySet = 0x00022875;
vTaskResume = 0x0002293d;
vTaskStartScheduler = 0x000229c1;
vTaskStepTick = 0x00022a51;
vTaskSuspend = 0x00022a81;
vTaskSuspendAll = 0x00022b3d;
vTaskSwitchContext = 0x00022b4d;
xPortStartScheduler = 0x00022bf5;
xQueueAddToSet = 0x00022cbd;
xQueueCreateCountingSemaphore = 0x00022ce1;
xQueueCreateCountingSemaphoreStatic = 0x00022d1d;
xQueueCreateMutex = 0x00022d61;
xQueueCreateMutexStatic = 0x00022d77;
xQueueCreateSet = 0x00022d91;
xQueueGenericCreate = 0x00022d99;
xQueueGenericCreateStatic = 0x00022de5;
xQueueGenericReset = 0x00022e4d;
xQueueGenericSend = 0x00022ed9;
xQueueGenericSendFromISR = 0x00023045;
xQueueGiveFromISR = 0x00023105;
xQueueGiveMutexRecursive = 0x000231a9;
xQueueIsQueueEmptyFromISR = 0x000231e9;
xQueueIsQueueFullFromISR = 0x0002320d;
xQueuePeek = 0x00023235;
xQueuePeekFromISR = 0x0002335d;
xQueueReceive = 0x000233c9;
xQueueReceiveFromISR = 0x000234f5;
xQueueRemoveFromSet = 0x00023589;
xQueueSelectFromSet = 0x000235ab;
xQueueSelectFromSetFromISR = 0x000235bd;
xQueueSemaphoreTake = 0x000235d1;
xQueueTakeMutexRecursive = 0x0002373d;
xTaskCheckForTimeOut = 0x00023781;
xTaskCreate = 0x000237f1;
xTaskCreateStatic = 0x0002384d;
xTaskGetCurrentTaskHandle = 0x000238bd;
xTaskGetSchedulerState = 0x000238c9;
xTaskGetTickCount = 0x000238e5;
xTaskGetTickCountFromISR = 0x000238f1;
xTaskIncrementTick = 0x00023901;
xTaskPriorityDisinherit = 0x000239cd;
xTaskPriorityInherit = 0x00023a61;
xTaskRemoveFromEventList = 0x00023af5;
xTaskResumeAll = 0x00023b75;
xTaskResumeFromISR = 0x00023c3d;
xTimerCreate = 0x00023cc9;
xTimerCreateStatic = 0x00023cfd;
xTimerCreateTimerTask = 0x00023d35;
xTimerGenericCommand = 0x00023da1;
xTimerGetExpiryTime = 0x00023e11;
xTimerGetTimerDaemonTaskHandle = 0x00023e31;
