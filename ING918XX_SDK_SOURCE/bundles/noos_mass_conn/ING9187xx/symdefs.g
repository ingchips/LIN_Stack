...
ll_config = 0x0000ca05;
ll_free = 0x0000ca15;
ll_get_heap_free_size = 0x0000ca21;
ll_hint_on_ce_len = 0x0000ca31;
ll_legacy_adv_set_interval = 0x0000ca69;
ll_malloc = 0x0000ca79;
ll_query_timing_info = 0x0000cbb1;
ll_scan_set_fixed_channel = 0x0000cc55;
ll_set_adv_access_address = 0x0000ce4d;
ll_set_adv_coded_scheme = 0x0000ce59;
ll_set_conn_coded_scheme = 0x0000ce89;
ll_set_conn_latency = 0x0000ceb5;
ll_set_conn_tx_power = 0x0000cee5;
ll_set_def_antenna = 0x0000cf2d;
ll_set_initiating_coded_scheme = 0x0000cf49;
ll_set_max_conn_number = 0x0000cf55;
nibble_for_char = 0x0001cec1;
platform_32k_rc_auto_tune = 0x0001cf5d;
platform_32k_rc_tune = 0x0001cfd9;
platform_calibrate_32k = 0x0001cfed;
platform_config = 0x0001cff1;
platform_controller_run = 0x0001d115;
platform_enable_irq = 0x0001d14d;
platform_get_gen_os_driver = 0x0001d185;
platform_get_task_handle = 0x0001d191;
platform_get_us_time = 0x0001d1a9;
platform_get_version = 0x0001d1ad;
platform_hrng = 0x0001d1b5;
platform_init_controller = 0x0001d1bd;
platform_os_idle_resumed_hook = 0x0001d1d9;
platform_patch_rf_init_data = 0x0001d1dd;
platform_post_sleep_processing = 0x0001d1e9;
platform_pre_sleep_processing = 0x0001d1ef;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001d1f5;
platform_printf = 0x0001d1f9;
platform_raise_assertion = 0x0001d20d;
platform_rand = 0x0001d221;
platform_read_info = 0x0001d225;
platform_read_persistent_reg = 0x0001d255;
platform_reset = 0x0001d265;
platform_set_evt_callback = 0x0001d289;
platform_set_evt_callback_table = 0x0001d29d;
platform_set_irq_callback = 0x0001d2a9;
platform_set_irq_callback_table = 0x0001d2c5;
platform_set_rf_clk_source = 0x0001d2d1;
platform_set_rf_init_data = 0x0001d2dd;
platform_set_rf_power_mapping = 0x0001d2e9;
platform_set_timer = 0x0001d2f5;
platform_shutdown = 0x0001d2f9;
platform_switch_app = 0x0001d2fd;
platform_trace_raw = 0x0001d329;
platform_write_persistent_reg = 0x0001d341;
printf_hexdump = 0x0001d351;
reverse_128 = 0x0001d68d;
reverse_24 = 0x0001d693;
reverse_48 = 0x0001d699;
reverse_56 = 0x0001d69f;
reverse_64 = 0x0001d6a5;
reverse_bd_addr = 0x0001d6ab;
reverse_bytes = 0x0001d6b1;
sm_add_event_handler = 0x0001d81d;
sm_address_resolution_lookup = 0x0001d975;
sm_authenticated = 0x0001dcd5;
sm_authorization_decline = 0x0001dce3;
sm_authorization_grant = 0x0001dd03;
sm_authorization_state = 0x0001dd23;
sm_bonding_decline = 0x0001dd3d;
sm_config = 0x0001e15d;
sm_config_conn = 0x0001e175;
sm_encryption_key_size = 0x0001e32b;
sm_just_works_confirm = 0x0001e865;
sm_le_device_key = 0x0001eba1;
sm_passkey_input = 0x0001ec37;
sm_private_random_address_generation_get = 0x0001efe5;
sm_private_random_address_generation_get_mode = 0x0001efed;
sm_private_random_address_generation_set_mode = 0x0001eff9;
sm_private_random_address_generation_set_update_period = 0x0001f021;
sm_register_oob_data_callback = 0x0001f15d;
sm_request_pairing = 0x0001f169;
sm_send_security_request = 0x0001fba3;
sm_set_accepted_stk_generation_methods = 0x0001fbc9;
sm_set_authentication_requirements = 0x0001fbd5;
sm_set_encryption_key_size_range = 0x0001fbe1;
sscanf_bd_addr = 0x0001ff3d;
sysSetPublicDeviceAddr = 0x000202f1;
uuid128_to_str = 0x000208d5;
uuid_add_bluetooth_prefix = 0x0002092d;
uuid_has_bluetooth_prefix = 0x0002094d;
