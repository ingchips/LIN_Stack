...
ll_config = 0x0000cdf9;
ll_free = 0x0000ce09;
ll_get_heap_free_size = 0x0000ce15;
ll_hint_on_ce_len = 0x0000ce25;
ll_legacy_adv_set_interval = 0x0000ce5d;
ll_malloc = 0x0000ce6d;
ll_query_timing_info = 0x0000cfa5;
ll_scan_set_fixed_channel = 0x0000d049;
ll_set_adv_access_address = 0x0000d241;
ll_set_adv_coded_scheme = 0x0000d24d;
ll_set_conn_coded_scheme = 0x0000d27d;
ll_set_conn_latency = 0x0000d2a9;
ll_set_conn_tx_power = 0x0000d2d9;
ll_set_def_antenna = 0x0000d321;
ll_set_initiating_coded_scheme = 0x0000d33d;
ll_set_max_conn_number = 0x0000d349;
...
platform_controller_run = 0x0001e3e9;
platform_enable_irq = 0x0001e421;
platform_get_gen_os_driver = 0x0001e459;
platform_get_task_handle = 0x0001e465;
...
platform_set_evt_callback = 0x0001e55d;
platform_set_evt_callback_table = 0x0001e571;
platform_set_irq_callback = 0x0001e57d;
platform_set_irq_callback_table = 0x0001e599;
platform_set_rf_clk_source = 0x0001e5a5;
platform_set_rf_init_data = 0x0001e5b1;
platform_set_rf_power_mapping = 0x0001e5bd;
platform_set_timer = 0x0001e5c9;
platform_shutdown = 0x0001e5cd;
platform_switch_app = 0x0001e5d1;
platform_trace_raw = 0x0001e5fd;
platform_write_persistent_reg = 0x0001e615;
printf_hexdump = 0x0001e625;
reverse_128 = 0x0001e999;
reverse_24 = 0x0001e99f;
reverse_48 = 0x0001e9a5;
reverse_56 = 0x0001e9ab;
reverse_64 = 0x0001e9b1;
reverse_bd_addr = 0x0001e9b7;
reverse_bytes = 0x0001e9bd;
sm_add_event_handler = 0x0001ec7d;
sm_address_resolution_lookup = 0x0001edd5;
sm_authenticated = 0x0001f135;
sm_authorization_decline = 0x0001f143;
sm_authorization_grant = 0x0001f163;
sm_authorization_state = 0x0001f183;
sm_bonding_decline = 0x0001f19d;
sm_config = 0x0001f5bd;
sm_config_conn = 0x0001f5d5;
sm_encryption_key_size = 0x0001f78b;
sm_just_works_confirm = 0x0001fcc5;
sm_le_device_key = 0x00020001;
sm_passkey_input = 0x00020097;
sm_private_random_address_generation_get = 0x00020445;
sm_private_random_address_generation_get_mode = 0x0002044d;
sm_private_random_address_generation_set_mode = 0x00020459;
sm_private_random_address_generation_set_update_period = 0x00020481;
sm_register_oob_data_callback = 0x000205bd;
sm_request_pairing = 0x000205c9;
sm_send_security_request = 0x00021003;
sm_set_accepted_stk_generation_methods = 0x00021029;
sm_set_authentication_requirements = 0x00021035;
sm_set_encryption_key_size_range = 0x00021041;
sscanf_bd_addr = 0x0002139d;
sysSetPublicDeviceAddr = 0x00021751;
uuid128_to_str = 0x00021ec9;
uuid_add_bluetooth_prefix = 0x00021f21;
uuid_has_bluetooth_prefix = 0x00021f41;
